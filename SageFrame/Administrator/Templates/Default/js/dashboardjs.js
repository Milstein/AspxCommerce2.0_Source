...
$(function() {
        ...
        vars:
    {
        ...
        tooltip: {
            ...
            BuildTooltipImage: function(id) {
                var image = '<img class="sfTooltip" src=' + SageFrame.tooltip.consts.helpImage + ' id=' + id + '>';
                return image;
            },
    ...
    $('div.sfMessage img.delete').live('click', function() {
