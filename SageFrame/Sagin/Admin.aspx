<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="SageFrame.Sagin_Admin" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<![endif]-->
    <asp:Literal ID="SageFrameModuleCSSlinks" runat="server" 
        meta:resourcekey="SageFrameModuleCSSlinksResource1"></asp:Literal>
...
<body>
    ...
    <div id="sfOuterwrapper">
        ...
        <div class="sfSagewrapper">
            ...
            <div class="sfMiddlemain">
                ...
                <p class="sfBack">
                    <asp:HyperLink ID="hypPreview" runat="server" Text="← Back to Home Page" 
                        meta:resourcekey="hypPreviewResource1"></asp:HyperLink>
                </p>
            </div>
        </div>
    </div>
    ...
    <asp:Literal ID="LitSageScript" runat="server" 
        meta:resourcekey="LitSageScriptResource1"></asp:Literal>
    </form>
</body>
</html>
