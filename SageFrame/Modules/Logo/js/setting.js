var LogoSetting = {
    ...
    GetData: function() {
        var myData = JSON2.stringify({ userModuleID: LogoSetting.config.moduleId, portalID: LogoSetting.config.portalId,CultureCode:LogoSetting.config.culture });
        $.ajax({
    ...
    Save: function() {
        ...
        var myData = JSON2.stringify({ logoText: logoText, logoPath: logoPath, userModuleID: LogoSetting.config.moduleId,
            portalID: LogoSetting.config.portalId, Slogan: slogan, URL: url,CultureCode:LogoSetting.config.culture
        });
        $.ajax({
            type: LogoSetting.config.type,
    ...
    DeleteIcon: function(IconPath) {
        $.ajax({
            ...
            data: JSON2.stringify({ IconPath: IconPath, userModuleID: LogoSetting.config.moduleId, CultureCode: LogoSetting.config.culture }),
            contentType: LogoSetting.config.contentType,
            dataType: LogoSetting.config.dataType,
