        ...
        var ModuleManager = {
            ...
            init: function() {
                ...
                $('#imgMobileSwitch').bind("click", function() {
                    ...
                    if ($(self).parent().hasClass("active")) {
                        ...
                        imagepath = SageFrameAppPath + '/Administrator/Templates/Default/images/iphone.png';
                        $(self).attr("src", imagepath);
                        $(self).attr("title", "Handheld Layout");
                        ...
                        imagepath = SageFrameAppPath + '/Administrator/Templates/Default/images/pcicon.png';
                        $(self).attr("src", imagepath);
                        $(self).attr("title", "PC Layout");
                ...
                $('#rdbAdminModules').live("click", function() {
                    $('#chkPortalModules').attr('checked', false);
                ...
                $('#spnBtnSave').live("click", function() {
                    ...
                    var UserModuleDetails = {
                        UserModule: {
                            ...
                            AddedBy: ModuleManager.config.UserName, LSTUserModulePermission: lstModulePermission,
                            IsInAdmin: $('#rdbAdminModules').attr("checked") ? true : false
                        }
                    };
            ...
            LoadSortModules: function(data) {
                ...
                if ($('#rdbGenralModules').length == 0)
                    ...
                    isAdmin = $('#rdbGenralModules').attr("checked") == true ? 0 : 1;
                this.config.method = "GetSortModules";
                this.config.url = this.config.baseURL + this.config.method;
                this.config.data = JSON2.stringify({
                    flag: ModuleManager.config.flag, isAdmin: isAdmin, PortalID: SageFramePortalID, IncludePortalModules: $("#chkPortalModules").attr("checked") == true ? 1 : 0
                });
            ...
            GetPageList_PopUp: function() {
                var isAdmin = $('#rdbAdminModules').attr("checked") ? 1 : 0;
            ...
            LoadModuleDetails: function(UserModuleID) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#chkInheritPermissions').attr("checked", usermodule.InheritViewPermissions);
