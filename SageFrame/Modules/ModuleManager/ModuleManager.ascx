...
<div class="sfFormwrapper sfPadding sfMarginbtn sfModuletopwrapper">
    ...
    <div id="Div1" class="sfHandheldswitch" style="display: none">
    ...
    <div id="handheldSwitch" class="sfHandheldswitch">
        <img alt="" id="imgMobileSwitch" title="Handheld Layout" src="<%=appPath%>/Administrator/Templates/Default/images/iphone.png" />
    </div>
    <div class="clear">
    </div>
</div>
