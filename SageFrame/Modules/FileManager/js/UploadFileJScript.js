...
(function ($) {
    ...
    $.fn.UploadFile = function (opt) {
        ...
        function LoadDocument() {
            var httpurl = WorkLogPath + "UploadHandler.ashx?mode=0" + "&fn=" + fileName;
            Upload(httpurl)
        }
        // ----End----
        function checkStatus() {
            width = "";
            height = "";
            var httpurl = WorkLogPath + "UploadHandler.ashx?wid=" + width + "&he=" + height + "&mode=1" + "&fn=" + fileName + "&gID=0";
            Upload(httpurl);
        }
        ...
        function createThumbnail(oWid, oHei) {
            ...
            httpurl = WorkLogPath + "UploadHandler.ashx?twid=" + tWidth + "&the=" + tHeight + "&x1=" + x1 + "&y1=" + y1 + "&wid=" + oWid + "&he=" + oHei + "&mode=2&edt=yes&fn=" + filename;
            Upload(httpurl);
        }
    }
})(jQuery);
