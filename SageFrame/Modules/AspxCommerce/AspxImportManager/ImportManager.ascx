    ...
    $(function() {
        ImportData = {
            ...
            GetAttributeList: function() {
                $.ajax({
                    type: "POST",
                    url: aspxservicePath + "AspxCommerceWebService.asmx/GetAttributesListForImport",
                    data: "",
            ...
            GetExcelData: function(fileName) {
                $.ajax({
                    type: "POST",
                    url: aspxservicePath + "AspxCommerceWebService.asmx/GetExcelConnection",
            ...
            GetExcelCostVariantData: function() {
                $.ajax({
                    type: "POST",
                    url: aspxservicePath + "AspxCommerceWebService.asmx/GetExcelCostVariantData",
                ...
                var upload = new AjaxUpload($('#dataFileUploader'), {
                    ...
                    onComplete: function(file, response) {
                        ...
                        if (res.Message != null && res.Status > 0) {
                            // $('#filePath').html("File Location:" + " " + aspxRedirectPath + res.Message);
            ...
            init: function() {
                ...
                //ImportData.GetExcelData(fileName);
                //ImportData.GetExcelCostVariantData();
                ...
                $("#btnMapping").click(function() {
                    ...
                    $("#divAttributeList").find("ul li input[type=text]").each(function() {
                        if ($(this).val() != '') {
                            var attrData = {
                                ...
                                InputTypeID: $(this).attr('inputid'),
                                ValidationTypeID: $(this).attr('validid'),
                                MappingID: $(this).val()
                            };
                    ...
                    $.ajax({
                        type: "POST",
                        url: aspxservicePath + "AspxCommerceWebService.asmx/GetExcelData",
...
<div id="fileUploader">
    <label class="sfLocale sfBold">Select File: </label>
...
<div id="divInfo">
    ...
    <input type="button" value="Back" id="btnBack" />--%>
        <p>
            <button type="button" id="btnMapping">
                <span><span class="sfLocale">Mapping</span></span></button>
        </p>
        <p>
            <button type="reset" id="btnBack">
