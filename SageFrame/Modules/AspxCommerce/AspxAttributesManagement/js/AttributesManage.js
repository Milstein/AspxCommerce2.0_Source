...
$(function() {
    ...
    attributesManage = {
        ...
        ClearForm: function() {
            ...
            $("#default_value_text").attr("class", "sfInputbox");
        ...
        BindAttributeGrid: function(attributeNm, required, SearchComparable, isSystem) {
            ...
            $("#gdvAttributes").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxAttributesManagement, 'Is Required'), name: 'IsRequired', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
                ...
                //{ display: " + getLocale(AspxAttributesManagement,'UpdatedOn') + ", name: 'UpdatedOn', cssclass: 'cssClassHeadDate', controlclass:'',coltype: 'label', align: 'left', type: 'date', format: 'dd/MM/yyyy' },
                ...
                //{ display: ' + getLocale(AspxAttributesManagement,"View") + ', name: 'view', enable: true, _event: 'click', trigger: '3', callMethod: 'ViewAttributes' },
        ...
        EditAttributes: function(tblID, argus) {
            ...
            switch (tblID) {
                case "gdvAttributes":
                    ...
                    $('#txtAttributeName').attr('disabled', 'disabled');
                    if (argus[7].toLowerCase() != "yes") {
                        ...
                        $('#activeTR').hide();
                        $("#ddlTypeValidation").attr('disabled', 'disabled');
                        $('input[name=chkUseInAdvancedSearch]').attr('disabled', 'disabled');
                        $('input[name=chkComparable]').attr('disabled', 'disabled');
                        $('input[name=chkIsUseInFilter]').attr('disabled', 'disabled');
                        $('input[name=chkUseForPriceRule]').attr('disabled', 'disabled');
                    }
                    ...
                    $("#default_value_text").attr("class", "sfInputbox " + attributesManage.CreateValidationClass(attValType) + "");
        ...
        SaveAttribute: function(_attributeId, _flag) {
            ...
            if (checkForm($("#form1"))) {
                ...
                if (!validateErrorMessage) {
                    ...
                    var _IsUseInFilter = $('input[name=chkIsUseInFilter]').attr('checked'); //false
                    ...
                    attributesManage.AddAttributeInfo(_attributeId, _attributeName, _inputTypeID, _DefaultValue,
                        ...
                        _IsIncludeInPriceRule, _StoreID, _PortalID, _IsActive, _IsModified, _UserName,
        ...
        AddAttributeInfo: function(_attributeId, _attributeName, _inputTypeID, _DefaultValue,
            ...
            _ShowInAdvanceSearch, _ShowInComparison, _IsUseInFilter, _IsIncludeInPriceRule,
        ...
        init: function(config) {
            ...
            $("#ddlTypeValidation").bind("change", function() {
                var attValType = $("#ddlTypeValidation").val();
                $("#default_value_text").attr("class", "sfInputbox " + attributesManage.CreateValidationClass(attValType) + "").val('');
                $('#iferror').hide();
                $('#iferror').html(attributesManage.GetValidationTypeErrorMessage(attValType));
            });
