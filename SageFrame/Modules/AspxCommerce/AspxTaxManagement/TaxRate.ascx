...
<div id="divTaxRatesGrid">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblTitle" runat="server" Text="Manage Tax Rates" 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="150">
                                <label class="cssClassLabel sfLocale ">
                                    Country:</label>
                                <select id="ddlSearchCountry" class="sfListmenu">
...
<div id="divTaxRateInformation" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblTaxRateHeading" runat="server" Text="Tax Rate Information" 
                    meta:resourcekey="lblTaxRateHeadingResource1"></asp:Label>
            </h2>
        </div>
        <div class="sfFormwrapper">
            <table cellspacing="0" cellpadding="0" border="0" class="cssClassPadding tdpadding">
                <tr>
                    <td>
                        <asp:Label ID="lblTaxRateTitle" runat="server" Text="Tax Rate Title:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblTaxRateTitleResource1"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblCountry" runat="server" Text="Country:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblCountryResource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblState" runat="server" Text="State/Province:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblStateResource1"></asp:Label>
                ...
                <tr id="trZipPostCode">
                    <td>
                        <asp:Label ID="lblZipPostCode" runat="server" Text="Zip/Post Code:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblZipPostCodeResource1"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblIsZipPostRange" runat="server" Text="Is Zip/Post Range:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblIsZipPostRangeResource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr id="trRangeFrom">
                    <td>
                        <asp:Label ID="lblRangeFrom" runat="server" Text="Range From:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblRangeFromResource1"></asp:Label>
                        <span class="cssClassRequired">*</span>
                    </td>
                    <td>
                        <input type="text" id="txtRangeFrom" name="rangefrom" minlength="5" class="sfInputbox required rangeFrom"/>
                        <span id="errmsgRangeFrom"></span>
                    </td>
                </tr>
                <tr id="trRangeTo">
                    <td>
                        <asp:Label ID="lblRangeTo" runat="server" Text="Range To:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblRangeToResource1"></asp:Label>
                       
                    </td>
                    <td>
                        <input type="text" id="txtRangeTo" name="rangeTo" minlength="5" class="sfInputbox required rangeTo" />
                        <span id="errmsgRangeTo"></span> <span class="cssClassRequired">*</span>
                    </td>
                </tr>
                  <tr>
                    <td>
                        <asp:Label ID="lblRateType" runat="server" Text="Rate Type:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblRateTypeResource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblTaxRateValue" runat="server" Text="Tax Rate:" 
                            CssClass="cssClassLabel" meta:resourcekey="lblTaxRateValueResource1"></asp:Label>
                    
                    </td>
                    <td>
                        <input type="text" id="txtTaxRateValue" name="taxRate" class="sfInputbox required" />
