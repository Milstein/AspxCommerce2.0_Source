    ...
    TaxRules = {
        ...
        init: function() {
            ...
            $("#btnSaveTaxRule").click(function() {
                if ($('#ddlCustomerRoleClass option:selected').val() == 0) {
                    $('#ddlCustomerRoleClass').attr('class', 'sfListmenu error');
                    return false;
                } else if ($('#ddlItemTaxClass option:selected').val() == 0) {
                    $('#ddlItemTaxClass').attr('class', 'sfListmenu error');
                    return false;
                } else if ($('#ddlTaxRate option:selected').val() == 0) {
                    $('#ddlTaxRate').attr('class', 'sfListmenu error');
                    return false;
                } else if (trm.form()) {
        ...
        BindTaxManageRules: function(ruleNm, roleName, itemClassNm, taxRateTitle, searchPriority, searchDisplayOrder) {
            ...
            $("#gdvTaxRulesDetails").sagegrid({
                ...
                param: data, // { ruleName: ruleNm, customerClassName: roleName, itemClassName: itemClassNm, rateTitle: taxRateTitle, priority: searchPriority, displayOrder: searchDisplayOrder, storeID: storeId, portalID: portalId, cultureName: cultureName },
                current: current_,
                pnew: offset_,
        ...
        SaveAndUpdateTaxRules: function() {
            ...
            //var roleID = $("#ddlCustomerRoleClass").val();
            var str1 = '';
            var str2 = '';
            var strRoleID = '';
            var strRoleName = '';
        ...
        SearchTaxManageRules: function() {
            ...
            if ($("#ddlCustomerRoleName").val() != 0) {
                //roleName = $.trim($("#ddlCustomerRoleName").val());
                var str1 = '';
                var str = '';
