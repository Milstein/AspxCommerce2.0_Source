    ...
    $(function() {
        ...
        TaxRate = {
            ...
            init: function() {
                ...
                $("#btnSaveTaxRate").click(function() {
                    if ($('#ddlCountry option:selected').val() != 0) {
                        ...
                        $('#ddlCountry ').attr('class', 'sfListmenu error');
                    }
                });
            ...
            GetTaxRateDataForExport: function() {
                ...
                this.config.data = JSON2.stringify({ offset: 1, limit: null, taxRateDataObj: taxRateDataObj, aspxCommonObj: aspxCommonObj });
            ...
            BindTaxRateExportData: function(data) {
                var exportData = '<thead><tr><th>' + getLocale(AspxTaxManagement, 'Tax Rate Title') + '</th><th>' + getLocale(AspxTaxManagement, 'Country') + '</th><th>' + getLocale(AspxTaxManagement, 'State/Province') + '</th><th>' + getLocale(AspxTaxManagement, 'Zip/Post Code') + '</th><th>' + getLocale(AspxTaxManagement, 'Zip/Post Is Range') + '</th><th>' + getLocale(AspxTaxManagement, 'Tax Rate Value') + '</th><th>' + getLocale(AspxTaxManagement, 'Is Rate Percentage') + '</th></tr></thead><tbody>';
                if (data.d.length > 0) {
                    ...
                    exportData += '<tr><td>' + getLocale(AspxTaxManagement, 'No Records Found!') + '</td></tr>';
                }
                exportData += '</tbody>';
            ...
            BindTaxRates: function(taxName, country, state, zipPostCode) {
                ...
                $("#gdvTaxRateDetails").sagegrid({
                    ...
                    colModel: [
                        ...
                        { display: getLocale(AspxTaxManagement, 'Zip/Post Is Range'), name: 'is_tax_zip_range', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left' },
                        { display: getLocale(AspxTaxManagement, 'Tax Rate Value'), name: 'tax_rate_value', cssclass: '', controlclass: '', coltype: 'label', align: 'left' },
                        { display: getLocale(AspxTaxManagement, 'Is Rate Percentage'), name: 'tax_rate_value', cssclass: '', controlclass: '', coltype: 'label', align: 'left' },
