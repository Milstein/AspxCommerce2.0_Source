    ...
    { 
       ...
       var objInf = new System.Collections.Specialized.NameValueCollection(30);
        ...
        else
        {
            ...
            rate = aws.GetCurrencyRateOnChange(aspxCommonObj, mainCurrency, gateWayCurrency.Trim(), "en-US");
        }
        ...
        try
        {
            ...
            if (objRetVals[0].Trim(char.Parse("|")) == "1")
            {
                ...
                var asws = new AspxCommerceWebService();               
               ...
               // StoreSettingConfig ssc = new StoreSettingConfig();
                ...
                {
                    asws.ClearSessionVariable("IsFreeShipping");

                }
                if (HttpContext.Current.Session["DiscountAmount"] != null)
                {
                    asws.ClearSessionVariable("DiscountAmount");

                }
                if (HttpContext.Current.Session["CouponCode"] != null)
                {
                    asws.ClearSessionVariable("CouponCode");
                ...
                asws.ClearSessionVariable("OrderCollection");
            }
            else
            {
                // Error!
