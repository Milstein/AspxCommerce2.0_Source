        ...
        <div class="cssClassHeader">
            ...
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    ...
                    <p>
                        <button type="button" id="btnAddNewBrand">
                            <span><span class="sfLocale">Add New Brand</span></span></button>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="sfFormwrapper">
            <table id="tblEditBrandManage" border="0" class="cssClassPadding tdpadding" width="100%">
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="lblIsShowInSlider" runat="server" Text="Is Shown In Slider:"
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblIsFeatured" runat="server" Text="Is Featured:" 
