    ...
    BrandManage = {
        ...
        BindBrandlistInGrid: function(brandName) {
            ...
            $("#tblBrandManage").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(Brand, "Is Shown InSlider"), name: '_isShowInSlider', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
                    { display: getLocale(Brand, "Is Featured"), name: '_isFeatured', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
                    ...
                    { display: getLocale(Brand, "Is Active"), name: '_isActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
        ...
        EditBrand: function(tblID, argus) {
            ...
            case "tblBrandManage":
                ...
                if (argus[6].toUpperCase() == 'YES') {
                    ...
                    $("#txtFeatureFrom").attr("disabled", "disabled");
                    $("#txtFeatureTo").attr("disabled", "disabled");
                }
        ...
        Init: function() {
            ...
            $("#btnAddNewBrand").click(function() {
                BrandID = 0;
                $('#_lblEditBrandName').html("Add New Brand");
                BrandManage.HideAllAdvertiseDivs();
                $("#divBrandProviderForm").show();
            });
            $("#btnDeleteSelected").click(function() {
                var brand_ids = '';
                $(".brandChkbox").each(function(i) {
            ...
            $("#btnSave").bind('click', function() {
                ...
                if ($("#divBrandImage>img").attr("src") == null) {
            ...
            $("#ddlIsFeatured").live("change", function() {
                if ($(this).val() == "0") {
                    $("#txtFeatureFrom").val('');
                    $("#txtFeatureTo").val('');
                    $("#txtFeatureFrom").attr("disabled", "disabled");
