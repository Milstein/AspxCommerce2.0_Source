        ...
        UserItemReviews = {
            ...
            BindReviewsAndRatingsGridByUser: function() {
                ...
                $("#gdvReviewsNRatings").sagegrid({
                    ...
                    { display: getLocale(AspxUserDashBoard, 'View From IP'), name: 'view_from_IP', cssclass: 'cssClassHeadNumber', controlclass: '', coltype: 'label', align: 'left', hide: false },
...
<div id="divShowItemRatingDetails">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <span><label id="lblReviewNRatingGridHeading" class="sfLocale">All Reviews and Ratings</label></span>
            </h2>
