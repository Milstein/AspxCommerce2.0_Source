                        ...
                        <div class="cssClassHeader">
                            ...
                            <div class="cssClassHeaderRight">
                                <div class="sfButtonwrapper ">
                                    <p>
                                        <button type="button" class="cssClassAddCategory" onclick="UserDashBoardCategoryMgmt.AddCategory()">
                                            <span><span class="sfLocale">Add Category</span></span></button>
                                    </p>
                                    <p>
                                        <button type="button" class="cssClassAddSubCategory" onclick="UserDashBoardCategoryMgmt.AddSubCategory()">
