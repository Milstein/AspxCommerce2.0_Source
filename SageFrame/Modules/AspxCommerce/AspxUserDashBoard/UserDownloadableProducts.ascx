...
<script type="text/javascript">
    ...
    UserDownloadable = {
        ...
        BindCustomerDownLoadItemsGrid: function(sku, Nm) {
            ...
            $("#gdvCustomerDownLoadItems").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxUserDashBoard, 'Last Download Date'), name: 'lastdownload', cssclass: 'cssClassHeadDate', controlclass: '', coltype: 'label', align: 'left', type: 'date', format: 'yyyy/MM/dd' },
        ...
        DownloadActualFile: function(argus) {
            ...
            //alert(!UserDownloadable.vars.isRemainDownload);
            //alert(argus[2]);
...
<div id="gdvDownLoadableItems_grid">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <label id="lblTitle" class="sfLocale">Customer Downloadable Items Processed</label>
            </h2>
        ...
        <div class="sfGridwrapper">
            <div class="sfGridWrapperContent">
                <div class="cssClassSearchPanel sfFormwrapper">
                    <table class="sfGridWrapperTable" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="UserDownloadable.SearchItems()">
...
<div id="gdvDownlodableItems">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <label id="lblCDI" class="sfLocale">Customer Downloadable Items Complete</label>
            </h2>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Name:</label>
                                <input type="text" id="txtNm" class="sfTextBoxSmall" />
                            </td>
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    SKU:</label>
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="UserDownloadable.SearchItem()">
                                            <span><span class="sfLocale">Search</span></span></button>
                                    </p>
                                </div>
                            </td>
