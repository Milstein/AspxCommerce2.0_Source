        ...
        BindShippingProviderNameInGrid: function(shippingProviderName, isAct) {
            ...
            $("#tblShippingProviderList").sagegrid({
                ...
                colModel: [
                     ...
                     { display: getLocale(AspxShippingManagement, 'Is Active'), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
        ...
        EditShippingProvider: function(tblID, argus) {
            switch (tblID) {
                case 'tblShippingProviderList':
                    ...
                    $("#chkIsActiveSP").attr('checked', shippingProviderMgmt.Boolean(argus[7]));
                    $("#btnSaveShippingProvider").attr("name", argus[0]);
                    editFlag = argus[0];

                    //call funtion to load remaining and added shipping method
                    //if provider has setting,provier type has dynamic call back
                    if (argus[6] != "") {
            ...
            var loadAddedShippingMethod = function(shippingProviderId) {
                ...
                $("#gdvShippingMethod").sagegrid({
                    ...
                    colModel: [
                         ...
                         { display: getLocale(AspxShippingManagement, 'IsActive'), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
                         { display: getLocale(AspxShippingManagement, 'Actions'), name: 'action', cssclass: 'cssClassAction', coltype: 'label', align: 'center' }
                     ],
            ...
            var loadremainginShippingMethod = function(id) {
                ...
                shippingProviderMgmt.ajaxSuccess = function(data) {
                    ...
                    $.each(data.d, function(index, item) {
                        //                                 if (index == 0) {
                        //                                     var $tr = $("<tr/>").html("<td colspan='2'>Add Shipping Methods</td>");
                        //                                     $table.append($tr);
                        //                                 }
                        var $td1 = $("<td/>");
                        var $checkbox = $("<input type='checkbox'/>").attr('value', item.ShippingMethodCode);
                        $td1.append($checkbox);
                    ...
                    $("#dvResponse").show(); //.find("#divShowShippingMethodGrid").hide();
                    $("#dvAddMethods").html('').append($table);
                    // csscody.info('<h2>Information Success</h2><p>Shipping Methods has been deleted.</p>');
                };
                shippingProviderMgmt.ajaxCall(shippingProviderMgmt.config);
            };
        ...
        SaveShippingProvider: function(shippingProviderID) {
            ...
            $("#dvResponse #tblShippingMethodAdd").find("tr").each(function(index, item) {
                ...
                if ($checkbox.is(":checked")) {
                    ...
                    shipingMethods.ShippingMethodCode = $checkbox.attr('value');
