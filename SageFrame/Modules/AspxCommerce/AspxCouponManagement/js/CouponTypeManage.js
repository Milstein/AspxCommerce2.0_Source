    ...
    couponTypeMgmt = {
        ...
        BindCouponTypeDetails: function(searchCouponType) {
            ...
            $("#gdvCouponType").sagegrid({
                ...
                buttons: [
                    { display: getLocale(AspxCouponManagement, "Edit"), name: 'edit', enable: true, _event: 'click', trigger: '1', callMethod: 'couponTypeMgmt.EditCouponType', arguments: '1,3' },
            ...
            switch (couponTypeMgmt.config.ajaxCallMode) {
                ...
                case 1:
                    ...
                    if (couponTypeFlag > 0) {
                        ...
                        csscody.info('<h2>Successful Message</h2><p>' + getLocale(AspxCouponManagement, "Coupon type has been saved successfully.") + '</p>');
                    }
                    couponTypeMgmt.HideAllCouponTypeDivs();
                ...
                case 2:
                    couponTypeMgmt.BindCouponTypeDetails(null);
                    csscody.info('<h2>Successful Message</h2><p>' + getLocale(AspxCouponManagement, "Coupon type has been deleted successfully.") + '</p>');
                    break;
                case 3:
                    isUnique = data.d;
                    if (data.d == true) {
        ...
        init: function() {
            ...
            $("#btnDeleteSelectedCouponType").click(function() {
                ...
                if (coupontype_ids == "") {
                    csscody.alert('<h2>' + getLocale(AspxCouponManagement, "Information Alert") + '</h2><p>' + getLocale(AspxCouponManagement, "Please select at least on coupon type before delete.") + '</p>');
                    return false;
                }
                var properties = {
                    onComplete: function(e) {
