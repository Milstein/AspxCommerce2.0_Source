...
$(function() {
    ...
    couponMgmt = {
        ...
        LoadCouponAjaxImage: function() {
            ...
            $('#btnRefresh').attr('src', '' + aspxTemplateFolderPath + '/images/refresh_icon.png');
        },
        ...
        AddUpdateCoupon: function(settingId, settingValue) {
            ...
            if (couponTypeId == 1) {
                var item_ids = '';
                $("#gdvPromoItems .itemsChkbox").each(function(i) {
                ...
                for (var nn in unames) {
                    ...
                    messageBodyHtml += '<p style="margin:0; padding:10px 0 0 0; font:bold 11px Arial, Helvetica, sans-serif; color:#666; text-align:left">' + couponAmount + getLocale(AspxCouponManagement, "Thank You,") + '<br /><span style="font-weight:normal; font-size:12px; font-family:Arial, Helvetica, sans-serif;">' + StoreName + ' Team </span></p></div></td></tr>';
        ...
        BindAllPortalUsersByCouponID: function(couponId, customerName) {
            ...
            $("#gdvPortalUser").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxCouponManagement, "User Name"), name: 'user_name', cssclass: '', controlclass: '', coltype: 'label', align: 'left', hide: true },
                    { display: getLocale(AspxCouponManagement, "Customer Name"), name: 'customer_name', cssclass: '', controlclass: '', coltype: 'label', align: 'left' },
                    { display: getLocale(AspxCouponManagement, "Email"), name: 'email', cssclass: '', controlclass: '', coltype: 'label', align: 'left', hide: true },
        ...
        GetAllItems: function(itemName, couponId) {
            ...
            $("#gdvPromoItems").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxCouponManagement, "Is Active?"), name: 'status', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', hide: true },
        ...
        BindCouponDetails: function(SearchCouponTypeId, SearchCouponCode, validateFromDate, validateToDate, userName) {
            ...
            $("#gdvCoupons").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxCouponManagement, "Is Free Shipping"), name: 'IsFreeShipping', cssclass: '', controlclass: '', coltype: 'label', align: 'left' },
                    ...
                    { display: getLocale(AspxCouponManagement, "Is Active"), name: 'is_active', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
            ...
            switch (tblID) {
                case "gdvCoupons":
                    ...
                    if (argus[3] != 1) {
                        ...
                        couponMgmt.BindPromoItems(argus[3], couponID);
                    }
                    break;
                default:
                    break;
        ...
        BindPromoItems: function(couponTypeId, couponId) {
            ...
            $("#gdvCouponUser").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxCouponManagement, "Promo Amount"), name: 'balance_amount', checkFor: '3', cssclass: 'cssClassHeadNumber', controlclass: 'cssClassFormatCurrency', coltype: 'currency', align: 'right' },
        ...
        EditCouponsStatus: function(tblID, argus) {
            switch (tblID) {
                case "gdvCouponUser":
                    ...
                    //$("#ddlCouponStatusType").val(argus[8]);
                    $('#ddlCouponStatusType').val($('#ddlCouponStatus option:contains(' + argus[10] + ')').attr('value'));
                    $('#ddlCouponStatusType').attr('disabled', 'disabled');
            ...
            switch (couponMgmt.config.ajaxCallMode) {
                ...
                case 3:
                    ...
                    if (checkMessage[1] == "emailSend" && checkMessage[0] == "dataSave") {
                        ...
                        //else {
                        //                            csscody.info("<h2>Information Message</h2><p>Coupon code has been saved successfully. <br/> But Email send fail for selected Customer.</p>");
                        //                        }
        ...
        init: function() {
            ...
            $("#btnSubmitCoupon").click(function() {
                ...
                if ($('#ddlCouponType option:selected').val() != 0) {
                    ...
                    $('#ddlCouponType').attr('class', 'sfListmenu error');
                    return false;
                }
            });
            $("#tblEditCouponForm tbody #trCouponCustomer").show();
            ...
            $("#btnDeleteSelectedCoupon").click(function() {
                ...
                if (deleteAllSelectedCouponUser == 1) {
                    $(".CouponViewChkbox").each(function(i) {
            ...
            $("#txtAmount").keypress(function(e) {
                if ($.trim($("#ddlCouponAmountType").val()) == 0) {
                    ...
                    if (e.which != 8 && e.which != 0 && e.which != 46 && e.which != 31 && (e.which < 48 || e.which > 57)) {
                        // $("#percError").html("Enter Digits And Decimal Only").css("color", "red").show().fadeOut(1600);
                        return false;
                    }
                    couponMgmt.bindfocusout();
                } else {
