...
$(function() {
    ...
    CouponStatusMgmt = {
        ...
        BindCouponsStatusInGrid: function(CouponStatusName, isAct) {
            ...
            $("#tblCouponStatusDetails").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxCouponManagement, "IsActive"), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No', hide: true },
        ...
        EditCouponStatus: function(tblID, argus) {
            ...
            case "tblCouponStatusDetails":
                ...
                var isactive = argus[4];
                    ...
                    //                        $("#chkIsActiveCoupon").attr('checked', 'checked');
                    //                    else
                    //                        $("#chkIsActiveCoupon").removeAttr('checked');
                $("#btnSaveCouponStatus").attr("name", argus[0]);
                break;
            default:
                break;
            }
        ...
        SaveCouponStatus: function(CouponStatusID) {
            ...
            this.config.method = "AspxCommerceWebService.asmx/AddUpdateCouponStatus";
        ...
        CheckCouponStatusUniquness: function(CouponStatusId) {
            ...
            this.config.method = "AspxCommerceWebService.asmx/CheckCouponStatusUniqueness";
            this.config.url = this.config.baseURL + this.config.method;
            ...
            $('#btnSaveCouponStatus').bind('click', function() {
                ...
                if (AspxCommerce.vars.IsAlive) {
                    ...
                    if (v.form() && CouponStatusMgmt.CheckCouponStatusUniquness(editFlag)) {
                        var CouponStatus_id = $(this).attr("name");
                        if (CouponStatus_id != '') {
