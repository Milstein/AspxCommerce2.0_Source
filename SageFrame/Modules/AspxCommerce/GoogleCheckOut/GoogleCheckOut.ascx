...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var AspxOrder = {
            ...
            init: function() {
                $('#btnGoogleCheckOut').live("click", function () {
            ...
            ajaxSuccess: function(data) {
                switch (AspxOrder.config.ajaxCallMode) {
                    ...
                    case 3:
                        ...
                        AspxOrder.SetSessionValue("GoogleCheckOutData", x);
                        document.location = '<%=PathGoogleCheckOut%>' + "PayThroughGoogleCheckOut" + pageExtension;
                        break;
                    case 4:
                        var x = AspxCommerce.utils.GetStoreID() + "#" + AspxCommerce.utils.GetPortalID() + "#" + AspxCommerce.utils.GetUserName() + "#" + AspxCommerce.utils.GetCustomerID() + "#" + AspxCommerce.utils.GetSessionCode() + "#" + AspxCommerce.utils.GetCultureName();
                        var itemIds = "";
...
<input type="button" id="btnGoogleCheckOut" class="sfLocale" value="Place Order (GoogleCheckOut)" />
