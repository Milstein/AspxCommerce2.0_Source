...
function AddCombinationListRow(obj) {
    ...
    $(".cssClassTableCostVariant:last").find(".ddlCostVariantsCollection").removeAttr("disabled").attr("enabled", "enabled");
    $(".cssClassTableCostVariant:last").find(".ddlCostVariantValues").html("<option value='0'>" + getLocale(AspxItemsManagement, "No values") + "</option>").removeAttr("disabled").attr("enabled", "enabled");
...
$(function() {
    ...
    ItemMangement = {
        ...
        LoadLowStockRssImage: function() {
            ...
            $('#lowStockRssImage').parent('a').removeAttr('href').attr('href', pageurl + '?type=rss&action=lowstockitems');
            $('#lowStockRssImage').removeAttr('src').attr('src', aspxTemplateFolderPath + '/images/rss-icon.png');
            $('#lowStockRssImage').removeAttr('title').attr('title', getLocale(AspxItemsManagement, 'Low Stock Items Rss Feed'));
            $('#lowStockRssImage').removeAttr('alt').attr('alt', getLocale(AspxItemsManagement, 'Low Stock Items Rss Feed'));
        },
        ...
        SubmitForm: function(frmID, attributeSetId, itemTypeId) {
            ...
            validNewDate = ItemMangement.ValidateExtraField("classNewFrom", "classNewTo", "date", getLocale(AspxItemsManagement, "To date must be higher date than From date!"));
            ...
            if ($('.FeaturedDropDown').val() == 3) {
                validFeaturedDate = ItemMangement.ValidateExtraField("classFeaturedFrom", "classFeaturedTo", "date", getLocale(AspxItemsManagement, "Featured To date must be higher date than Featured From date!"));
            }
            else {
            ...
            if ($('.SpecialDropDown').val() == 5) {
                validSpecialDate = ItemMangement.ValidateExtraField("classSpecialFrom", "classSpecialTo", "date", getLocale(AspxItemsManagement, "Special To date must be higher date than Special From date!"));
            }
            else {
        ...
        SaveItemCostVariantsInfo: function() {
            ItemMangement.SaveItemCostVariant();
        },
        ...
        EditItems: function(tblID, argus) {
            ...
            switch (tblID) {
                case "gdvItems":
                    ...
                    ItemMangement.InitCostVariantCombination(argus[0]);
                    var itemSKUTxtBoxID = $("#hdnSKUTxtBox").val();
                    var sku = $("#" + itemSKUTxtBoxID).val();
                    ItemMangement.vars.sku = sku;
                    //   $("#ddlCurrency").val(argus[5]);
            ...
            $('.classAddImages').live('click', function() {
                ...
                if (listImages[value] != null && listImages[value] != "") {
                    ...
                    $.each(subStr, function(index) {
                        List += '<tr>';
                        List += '<td><img src="' + aspxRootPath + "Modules/AspxCommerce/AspxItemsManagement/uploads/" + subStr[index] + '" class="uploadImage" height="20px" width="30px"/></td>';
        ...
        CreateAccordion: function(attGroup, attributeSetId, itemTypeId, showDeleteBtn) {
            ...
            if (itemTypeId == 2) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab2' href='#dv_Content_2'>" + getLocale(AspxItemsManagement, "Download Information") + "</a></li>";
                tabs += '<div class="st_tab_view" id="dv_Content_2"><h3><a href="#">' + getLocale(AspxItemsManagement, "Download Information") + '</a></h3>';
                tabs += '<div id="divDownloadInfo">';
                tabs += '<table class="sfFormwrapper" width="100%" border="0" cellpadding="o" cellspacing="0">';
                tabs += '<tbody>';
                tabs += '<tr><td><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Title:") + '</span></td><td class="cssClassTableRightCol"><div class="field required"><input type="textbox" id="txtDownloadTitle" class="sfInputbox" maxlength="256"/><span class="iferror"></span></div></td></tr>';
                tabs += '<tr><td><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Maximum Download:") + '</span></td><td class="cssClassTableRightCol"><div class="field required"><input type="textbox" id="txtMaxDownload" class="sfInputbox" maxlength="3"/><span class="iferror">' + getLocale(AspxItemsManagement, "Integer Number") + '</span></div></td></tr>';
                ...
                tabs += '<tr><td><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Sample File:") + '</span></td><td class="cssClassTableRightCol"><input id="fileSample" type="file" class="cssClassBrowse notTest" /><span id="spanSample" class="cssClassLabel"></span></td></tr>';
                tabs += '<tr><td><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Actual File:") + ' </span></td><td class="cssClassTableRightCol"><input id="fileActual" type="file" class="cssClassBrowse notTest" /><span id="spanActual" class="cssClassLabel"></span></td></tr>';
                ...
                tabs += '<div class="st_tab_view" id="dv_Content_3"><h3><a href="#">' + getLocale(AspxItemsManagement, "Item Tax Class") + '</a></h3><div id="divTax"><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Item Tax Class Name:") + '</span><select id="ddlTax" class="sfListmenu" /></div></div>';
            } else {
                quickNavigation += "<li><a class='st_tab' rel='v_tab3' href='#dv_Content_3'>" + getLocale(AspxItemsManagement, "Item Tax Class") + "</a></li>";
            ...
            if (itemTypeId == 1 || itemTypeId == 2) {
                ...
                tabs += '<div class="st_tab_view" id="dv_Content_4"><h3><a href="#">' + getLocale(AspxItemsManagement, "Brand") + '</a></h3><div id="tblBrandTree" width="100%" border="0" cellpadding="0" cellspacing="0"><select id="lstBrands" class="cssClassMultiSelect"></select><span id="spanNoBrand" class="cssClassLabel"></span></div></div>';
            }
            if (itemTypeId == 3) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab5' href='#dv_Content_5'>" + getLocale(AspxItemsManagement, "Gift Card Category") + "</a></li>";
                tabs += '<div class="st_tab_view" id="dv_Content_5"><h3><a href="#">' + getLocale(AspxItemsManagement, "Gift Card Category") + '</a></h3>';
                tabs += '<div id="divGCThemes" class="sfFormwrapper">';
                tabs += '<table  width="100%" border="0" cellpadding="o" cellspacing="0">';
                tabs += '<tbody>';
                tabs += '<tr><td><span class="cssClassLabel">' + getLocale(AspxItemsManagement, "Gift Card Category:") + '</span></td><td class="cssClassTableRightCol"><div ><select  multiple="multiple" id="ddlGCCategory"  style="width:200px;height:100px"><option value="0">' + getLocale(AspxItemsManagement, "ALL") + '</option></select></div><div><span>' + getLocale(AspxItemsManagement, "(* select category of gift card)") + '</span></div></td></tr>';
                tabs += '</tbody>';
                tabs += '</table></div></div>';

            }
            quickNavigation += "<li><a class='st_tab' rel='v_tab6' href='#dv_Content_6'>" + getLocale(AspxItemsManagement, "Images") + "</a></li>";
            quickNavigation += "<li><a class='st_tab' rel='v_tab7' href='#dv_Content_7'>" + getLocale(AspxItemsManagement, "Videos") + "</a></li>";
            if (itemTypeId != 3) {
                quickNavigation += "<li><a class='st_tab' rel='v_tab8' href='#dv_Content_8'>" + getLocale(AspxItemsManagement, "Categories") + "</a></li>";
            }
            tabs += '<div class="st_tab_view" id="dv_Content_6"><h3><a href="#">' + getLocale(AspxItemsManagement, "Images") + '</a></h3><div id="multipleUpload"><div id="divUploader"><div id="fileUpload" ></div><div class="progress ui-helper-clearfix"><div class="progressBar" id="progressBar"></div><div class="percentage"></div></div></div>';
            ...
            tabs += '<div class="st_tab_view" id="dv_Content_7"><h3><a href="#">' + getLocale(AspxItemsManagement, "Videos") + '</a></h3><div><table id="tblVideosTree" width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td><label id="lblVideoID" class="cssClassLabel">' + getLocale(AspxItemsManagement, "YouTube Video Ids :") + '</label></td><td class="cssClassTableRightCol"><input type="text" class="sfInputbox  cssClassItemName" title=' + getLocale(AspxItemsManagement, "Enter Youtube Video Id, If Multiple Separeted With Comma") + ' id="txtVideoID"/></td></table></div></div>';
            if (itemTypeId != 3) {
                tabs += '<div class="st_tab_view" id="dv_Content_8"><h3><a href="#">' + getLocale(AspxItemsManagement, "Categories") + '</a></h3><div id="tblCategoryTree" width="100%" border="0" cellpadding="0" cellspacing="0"><select id="lstCategories" class="cssClassMultiSelect"></select><span id="spanNoCat" class="cssClassLabel"></span></div></div>';
            }
            if (showDeleteBtn) {
                if (itemTypeId != 2 && itemTypeId != 3 && itemTypeId != 4) {
                    ...
                    tabs += '<div class="st_tab_view" id="dv_Content_9"><h3><a href="#">' + getLocale(AspxItemsManagement, "Cost Variant Combination") + '</a></h3><div><div class="sfGridwrapper" id="dvCvForm">';
                    ...
                    tabs += '</div><div class="sfButtonwrapper"><p><button id="btnBackCostVariantCombination" type="button"><span><span>' + getLocale(AspxItemsManagement, "Back") + '</span></span></button></p> <p><button id="btnCancelCostVariantCombination" type="button"><span><span>' + getLocale(AspxItemsManagement, "Reset") + '</span></span></button></p><p><button id="btnSaveCostVariantCombination" type="button"><span><span>' + getLocale(AspxItemsManagement, "Save Cost Variants Combination") + 'Option</span></span></button></p><p><button id="btnDeleteCostVariantCombination" type="button"><span><span>' + getLocale(AspxItemsManagement, "Delete Cost Variants Combination Option") + '</span></span></button></p></div>';
                    tabs += ' <div id="dvCostVarAdd" style="display:none;" class="sfButtonwrapper"><p><button id="btnAddCostVariantCombination" type="button"><span><span>' + getLocale(AspxItemsManagement, "Add Cost Variants Combination Option") + '</span></span></button></p></div></div></div>';

                    //Item Quantity Discounts
                    quickNavigation += "<li><a class='st_tab' rel='v_tab10' href='#dv_Content_10'>" + getLocale(AspxItemsManagement, "Item Quantity Discounts") + "</a></li>";
                    tabs += '<div class="st_tab_view" id="dv_Content_10"><h3><a href="#">' + getLocale(AspxItemsManagement, "Item Quantity Discounts (Tier Price Options)") + '</a></h3><div id="dvAddNewQuantityDiscount" style="display:none;"><div class="sfButtonwrapper"><p><button type="button" id="btnAddQuantityDiscount" ><span><span>' + getLocale(AspxItemsManagement, "Add New") + '</span></span></button></p></div></div><div class="sfFormwrapper"><table width="100%" cellspacing="0" cellpadding="0" id="tblQuantityDiscount"><thead><tr class="cssClassHeading"><td>' + getLocale(AspxItemsManagement, "Quantity More Than") + ':</td><td class="cssClassUnitPrice">' + getLocale(AspxItemsManagement, "Unit Price") + '(' + currencyCodeSlected + '):</td><td>' + getLocale(AspxItemsManagement, "User In Role") + ':</td><td>&nbsp;</td></tr></thead><tbody></tbody></table>';
                    tabs += '<div class="sfButtonwrapper"><p><button type="button" id="btnSaveQuantityDiscount" ><span><span>' + getLocale(AspxItemsManagement, "Save") + '</span></span></button></p><p><button type="button" id="btnDeleteQuantityDiscount" ><span><span>' + getLocale(AspxItemsManagement, "Delete") + '</span></span></button></p></div></div></div>';
                }
            }
            quickNavigation += "<li><a class='st_tab' rel='v_tab11' href='#dv_Content_11'>" + getLocale(AspxItemsManagement, "Related Items") + "</a></li>";
            quickNavigation += "<li><a class='st_tab' rel='v_tab12' href='#dv_Content_12'>" + getLocale(AspxItemsManagement, "Up-sells") + "</a></li>";
            quickNavigation += "<li><a class='st_tab' rel='v_tab13' href='#dv_Content_13'>" + getLocale(AspxItemsManagement, "Cross-sells") + "</a></li>";

            tabs += '<div class="st_tab_view" id="dv_Content_11"><h3><a href="#">' + getLocale(AspxItemsManagement, "Related Items") + '</a></h3><div class="sfGridwrapper">'
                ...
                + '<td><div class="sfButtonwrapper cssClassPaddingNone"><p><button type="button" id="btnSearchRelatedItems"><span>' + getLocale(AspxItemsManagement, "Search") + '</span></button></p></div></td>'
                + '</tr></table>'
                + '</div></div></div>'

            + '<table id="gdvRelatedItems" width="100%" border="0" cellpadding="0" cellspacing="0"></table></div></div>';

            tabs += '<div class="st_tab_view" id="dv_Content_12"><h3><a href="#">' + getLocale(AspxItemsManagement, "Up-sells") + '</a></h3><div class="sfGridwrapper">'
             ...
             + '<div class="sfGridwrapper"><div class="sfGridWrapperContent"><div class="cssClassSearchPanel sfFormwrapper">'
                ...
                + '<td><div class="sfButtonwrapper cssClassPaddingNone"><p><button type="button" id="btnSearchUpSellItems"><span>' + getLocale(AspxItemsManagement, "Search") + '</span></button></p></div></td>'
                + '</tr></table>'
                + '</div></div></div>'

           + '<table id="gdvUpSellItems" width="100%" border="0" cellpadding="0" cellspacing="0"></table></div></div>';

            tabs += '<div class="st_tab_view" id="dv_Content_13"><h3><a href="#">' + getLocale(AspxItemsManagement, "Cross-sells") + '</a></h3><div class="sfGridwrapper">'
              ...
              + '<div class="sfGridwrapper"><div class="sfGridWrapperContent"><div class="cssClassSearchPanel sfFormwrapper">'
                ...
                + '<td><div class="sfButtonwrapper cssClassPaddingNone"><p><button type="button" id="btnSearchCrossSellItems"><span>' + getLocale(AspxItemsManagement, "Search") + '</span></button></p></div></td>'
                + '</tr></table>'
                + '</div></div></div>'
            ...
            //Create buttons
            var buttons = '<div class="sfButtonwrapper"><p><button type="button" id="btnReturn"><span><span>' + getLocale(AspxItemsManagement, "Back") + '</span></span></button></p>';
            if (!showDeleteBtn) {
                buttons += '<p><button type="button" id="btnResetForm" ><span><span>' + getLocale(AspxItemsManagement, "Reset") + '</span></span> </button></p>';
            }
            else {
                buttons += '<p><button type="button" id="btnDelete" class="delbutton" ><span><span>' + getLocale(AspxItemsManagement, "Delete Item") + '</span></span> </button></p>';
            }
            buttons += '<p><button type="button" id="saveForm"  onclick="ItemMangement.SubmitForm(' + frmIDQuoted + ',' + attributeSetId + ',' + itemTypeId + ')" ><span><span>' + getLocale(AspxItemsManagement, "Save Item") + '</span></span></button></p>';
        ...
        GetValidationTypeErrorMessage: function(attValType) {
            ...
            switch (attValType) {
                case 1: //AlphabetsOnly
                    retString = getLocale(AspxItemsManagement, "Alphabets Only");
                    break;
                case 2: //AlphaNumeric
                    retString = getLocale(AspxItemsManagement, "AlphaNumeric");
                    break;
                case 3: //DecimalNumber
                    retString = getLocale(AspxItemsManagement, "Decimal Number");
                    break;
                case 4: //Email
                    retString = getLocale(AspxItemsManagement, "Email Address");
                    break;
                case 5: //IntegerNumber
                    retString = getLocale(AspxItemsManagement, "Integer Number");
                    break;
                case 6: //Price
                    retString = getLocale(AspxItemsManagement, "Price error");
                    break;
                case 7: //WebURL
                    retString = getLocale(AspxItemsManagement, "Web URL");
                    break;
            }
            return retString;
        },
        ...
        SaveItem: function(formID, attributeSetId, itemTypeId, itemId) {
            ...
            if (counter <= 1) {
                ...
                if (itemTypeId == 3) {
                    ...
                    categoriesSelected = true; //GIFT CARD STATIC
                } else {
            ...
            switch (ItemMangement.config.ajaxCallMode) {
                ...
                case 2:
                    ...
                    if (msg.d.length > 0) {
                        ...
                        newQuantityDiscountRow += '<td><div class="cssClassUsersInRoleCheckBox"></div></td>';
                        newQuantityDiscountRow += '<td><span class="nowrap">';
                        newQuantityDiscountRow += '<img width="13" height="18" border="0" align="top" class="cssClassAddDiscountRow" title=' + getLocale(AspxItemsManagement, "Add empty item") + ' alt=' + getLocale(AspxItemsManagement, "Add empty item") + ' name="add" src="' + aspxTemplateFolderPath + '/images/admin/icon_add.gif" >&nbsp;';
                        newQuantityDiscountRow += '<img width="13" height="18" border="0" align="top" class="cssClassCloneDiscountRow" alt=' + getLocale(AspxItemsManagement, "Clone this item") + ' title=' + getLocale(AspxItemsManagement, "Clone this item") + ' name="clone" src="' + aspxTemplateFolderPath + '/images/admin/icon_clone.gif" >&nbsp;';
                        newQuantityDiscountRow += '<img width="12" height="18" border="0" align="top" class="cssClassDeleteDiscountRow" alt=' + getLocale(AspxItemsManagement, "Remove this item") + ' name="remove" src="' + aspxTemplateFolderPath + '/images/admin/icon_delete.gif" >&nbsp;';
                        newQuantityDiscountRow += '</span></td></tr>';
                        $("#tblQuantityDiscount>tbody").append(newQuantityDiscountRow);
                        ItemMangement.GetUserInRoleList(arrItems);
                    }
                ...
                case 8:
                    if (msg.d.length > 0) {
                        ...
                        $.each(msg.d, function(index, item) {
                            ...
                            newVariantRow += '<button type="button" value=' + index + ' name="' + item.ImagePath + '" class="classAddImagesEdit" rel="popuprel2" onclick="ItemMangement.AddImages(this,' + index + ')" ><span><span>' + getLocale(AspxItemsManagement, "Add Images") + '</span></span></button>';
                ...
                case 20:
                    ...
                    $("#ddlCurrency").change(function() {
                        ...
                        ItemMangement.InitCostVariantCombination($("#ItemMgt_itemID").val());
