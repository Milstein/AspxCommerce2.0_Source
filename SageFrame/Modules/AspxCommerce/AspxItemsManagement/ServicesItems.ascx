        ...
        serviceManage = {
            ...
            BindServiceEmpDetails: function(Id, empId, itemNm) {
                ...
                $("#gvdServiceEmpDetails").sagegrid({
                    ...
                    buttons: [
                    //                        { display: 'View Available Time', name: 'view', enable: true, _event: 'click', trigger: '1', callMethod: 'serviceManage.ViewAvailableTime', arguments: '1,2,3,4,5,6,7,8,9' },
                    //                        { display: 'Booked Time', name: 'bookedtime', enable: true, _event: 'click', trigger: '1', callMethod: 'serviceManage.BookingDetails', arguments: '1,2,3' }
                    ],
                    txtClass: 'sfInputbox',
                    rp: perpage,
                    nomsg: getLocale(AspxItemsManagement, "No Records Found!"),
...
<div id="divServicesGrid">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblTitle" runat="server" Text="Service Management" meta:resourcekey="lblTitleResource1"></asp:Label>
            </h1>
                      ...
                      <td width="150">
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="serviceManage.SearchService()">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="serviceManage.SearchEmp()">
                                            <span><span class="sflocale">Search</span></span></button>
                                    </p>
                                    <p>
                                        <button type="button" id="btnBack"><span><span class="sflocale">Back</span></span></</button>
                                    </p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="serviceManage.SearchServiceEmp()">
                                            <span><span class="sflocale">Search</span></span></button>
                                    </p>
                                    <p>
                                        <button type="button" id="btnBackServiceEmp"><span><span class="sflocale">Back</span></span></</button>
                                    </p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="serviceManage.SearchBooking()">
                                            <span><span class="sflocale">Search</span></span></button>
                                    </p>
                                    <p>
                                        <button type="button" id="btnBackToEmp"><span><span class="sflocale">Back</span></span></</button>
                                    </p>
                                </div>
                            </td>
                        </tr>
