...
public partial class Modules_AspxCommerce_AspxPromoCodes_PromoCodes : BaseAdministrationUserControl
{
    public int StoreID, PortalID, CustomerID, UserModuleID;
    public string UserName, CultureName, PromoItemsUrl;
    ...
    {
        IncludeJs("PromoCodeView", "/js/jquery.tipsy.js", "/js/jquery.masonry.js", "/js/DateTime/date.js");
        StoreID = GetStoreID;
        ...
        AllowAddToCompareLatest = ssc.GetStoreSettingsByKey(StoreSetting.EnableCompareItems, StoreID, PortalID,
                                                CultureName);
        PromoItemsUrl = ssc.GetStoreSettingsByKey(StoreSetting.PromoItemsUrl, StoreID, PortalID,
                                                CultureName);
        IncludeLanguageJS();
    }
}
