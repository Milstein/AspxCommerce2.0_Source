    ...
    $(function () {
        ...
        var setting = function() {
            ...
            var saveUspsSetting = function() {
                ...
                if (v.form()) {
                    //int providerId, string settingKey, string settingValue, int storeId, int portalId, string cultureName, string userName
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" id="btnSaveUspsSetting">
