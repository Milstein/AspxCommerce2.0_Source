...
$(function() {
    ...
    WishItems = {
        ...
        BindRecentWishItemList: function(msg) {
            ...
            //            <table class="cssClassMyWishItemTable" id="tblWishItem" width="100%">
            ...
            if (msg.d.length > 0) {
                ...
                //    var wishListHeadingLabel = '<tr><td> <h3><label ID="lblWishListTitle" class="cssClassGowishlistHead"><span>' + getLocale(AspxWishItems, "Last Added Items") + '</span><label></h3></td></tr>';
                ...
                wishItem += "</table></div>";
                //var wishListFooter = '<tr><td><a href="' + AspxCommerce.utils.GetAspxRedirectPath() + myWishListLink + '" id="lnkGoToWishlist"> <span class="gowishlist">' + getLocale(AspxWishItems, "Go to Wishlist") + '</span></a></td></tr>';
