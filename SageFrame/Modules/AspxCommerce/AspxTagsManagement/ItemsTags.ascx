...
<div id="divItemTagDetails">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblTagHeading" runat="server" Text="Items Tags" 
                    meta:resourcekey="lblTagHeadingResource1"></asp:Label>
            </h1>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnExportDataToExcelItemTag" runat="server" 
                            OnClick="Button1_Click" Text="Export to Excel"
                            CssClass="cssClassButtonSubmit" 
                            OnClientClick="ItemTags.ExportDataToExcelItemTags()" 
                            meta:resourcekey="btnExportDataToExcelItemTagResource1" />
                    </p>
                    <p>
                            <asp:Button  ID="btnExportItemTag" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonItemTag_Click" Text="Export to CSV" 
                                OnClientClick="ItemTags.ExportItemTagToCsvData()" 
                                meta:resourcekey="btnExportItemTagResource1"/> 
                    </p>
...
<div id="divShowItemsTagsList" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblShowItemTagHeading" runat="server" 
                    meta:resourcekey="lblShowItemTagHeadingResource1"></asp:Label>
            </h2>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnExportToExcelItemTag" runat="server" OnClick="Button2_Click" Text="Export to Excel"
                             CssClass="cssClassButtonSubmit" 
                            OnClientClick="ItemTags.ExportDivDataToExcelItemTags()" 
                            meta:resourcekey="btnExportToExcelItemTagResource1" />
                    </p>
                    <p>
                            <asp:Button  ID="btnExportToCSV" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonItemTagDetail_Click" Text="Export to CSV" 
                                OnClientClick="ItemTags.ExportItemTagDetailToCsvData()" 
