...
$(function() {
    ...
    AllTags = {
        ...
        LoadItemTagRssImage: function() {
            ...
            $('#allTagsRssImage').parent('a').removeAttr('href').attr('href', pageurl + '?type=rss&action=newtags');
            $('#allTagsRssImage').removeAttr('src').attr('src', aspxTemplateFolderPath + '/images/rss-icon.png');
            $('#allTagsRssImage').removeAttr('title').attr('title', getLocale(AspxTagsManagement,'New Tag Rss Feed'));
            $('#allTagsRssImage').removeAttr('alt').attr('alt', getLocale(AspxTagsManagement,'New Tag Rss Feed'));
        },
        init: function() {
            AllTags.HideAll();
            ...
            $("#tblTagsItems>tbody>tr .classStatusList").live("change", function() {
        ...
        ajaxSuccess: function(data) {
            ...
            case 5:
                ...
                $.each(data.d, function(index, item) {
                    ...
                    tableElements += '</tr>';
                    $("#table>tbody>tr .classStatusList").find("option[text=" + item.Status + "]").attr("selected", "selected");
