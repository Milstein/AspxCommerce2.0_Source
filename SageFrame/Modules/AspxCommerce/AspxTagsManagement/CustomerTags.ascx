...
<div id="divCustomerTagDetails">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblTagHeading" runat="server" Text="Customers Tags" 
                ...
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnExportDataToExcel" runat="server" OnClick="Button1_Click" Text="Export to Excel"
                            ...
                            OnClientClick="CustomerTags.ExportCustomerTagDataToExcel()" 
                            meta:resourcekey="btnExportDataToExcelResource1"/>
                    </p>
                    <p>
                            <asp:Button  ID="btnExport" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonCustomerTags_Click" Text="Export to CSV" 
                                OnClientClick="CustomerTags.ExportCustomertagToCsvData()" 
...
<div id="divShowCustomerTagList" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblShowHeading" runat="server" 
                    meta:resourcekey="lblShowHeadingResource1"></asp:Label>
            </h2>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
           ...
           CssClass="cssClassButtonSubmit"  
                            OnClientClick="CustomerTags.ExportCustomerTagListDataToExcel()" 
                            meta:resourcekey="btnExportToExcelResource1"/>
                    </p>
                    <p>
                            <asp:Button  ID="btnExportToCSV" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonCustomerTagsDetail_Click" Text="Export to CSV" 
                                OnClientClick="CustomerTags.ExportCustomertagDetailToCsvData()" 
