        ...
        StoreBranchManage = {
            ...
            BindStoreBranchDetails: function() {
                ...
                $("#gdvBranchManage").sagegrid({
                    ...
                    current: current_,
                    pnew: offset_,
                    sortcol: { o: { sorter: false }, 4: { sorter: false} }
                });
            },
                ...
                switch (tblID) {
                    case "gdvBranchManage":
                        ...
                        if (argus[5] != null && argus[5] != "") {
                            $("#storeBranchIcon").html('<img src="' + aspxRootPath + "Modules/AspxCommerce/AspxStoreBranchesManagement/uploads/" + argus[5] + '" class="uploadImage" height="144px" width="256px"/><img src="' + aspxRootPath + 'Administrator/Templates/Default/images/delete.png' + '" id="btnImageClose" alt="Delete" title="Delete" />');
                        }
            ...
            SaveAndUpdateStoreBranch: function() {
                ...
                if ($("#storeBranchIcon>img").length > 0) {
                    branchImage = $("#storeBranchIcon>img:eq(0)").attr("src").replace(aspxRootPath, "");
            ...
            AddNewImages: function(response) {
                if (response.Message != null && response.Message != "") {
                    $("#storeBranchIcon").html('<img src="' + aspxRootPath + response.Message + '" class="uploadImage" height="144px" width="256px"/><img src="' + aspxRootPath + 'Administrator/Templates/Default/images/delete.png' + '" id="btnImageClose" alt="Delete" title="Delete" />');
                }
            },
            ...
            init: function() {
                ...
                $("#btnImageClose").live('click', function() {
                    $("#storeBranchIcon").html('');
                });
                $('#btnDeleteSelected').click(function() {
                    var storeBranchIds = '';
                    $(".StoreBranchChkbox").each(function(i) {
                        if ($(this).attr("checked")) {
                            storeBranchIds += $(this).val() + ',';
                        }
                    });
                    if (storeBranchIds != "") {
                        var properties = {
        ...
        <div class="cssClassHeader">
            ...
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    ...
                    <p>
                        <button type="button" id="btnAddNewStoreBranch">
                            <span><span class="sfLocale">Add New Branch</span></span></button>
                    </p>
