        ...
        BindPaymentMethodGrid: function(paymentgatewayName, isAct) {
            ...
            $("#gdvPaymentGateway").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxPaymentGateWayManagement, 'Is Active'), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'True/False' },
                    { display: getLocale(AspxPaymentGateWayManagement, 'Is Use'), name: 'IsUSE', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'True/False' },
        ...
        EditPaymentMethod: function(tblID, argus) {
            ...
            switch (tblID) {
                case "gdvPaymentGateway":
                    ...
                    $("#" + lblPaymentGatewayEdit).html("Editing Payment Gateway Method: " + argus[3]);
                    PaymentGatewayManage.HideAllDivs();
        ...
        BindOrderList: function(argus, billNm, shipNm, orderStatusType) {
            ...
            $("#gdvPaymentGatewayEdit").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxPaymentGateWayManagement, 'AddedOn'), name: 'AddedOn', cssclass: 'cssClassHeadDate', controlclass: '', coltype: 'label', align: 'left', type: 'date', format: 'yyyy/MM/dd' },
