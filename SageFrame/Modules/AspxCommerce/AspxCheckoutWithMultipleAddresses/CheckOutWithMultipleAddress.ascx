                ...
                switch (CheckOut.config.ajaxCallMode) {
                    ...
                    case 10: //cart details                       
                        ...
                        if (cartItemCount == 0) {
                            ...
                            $('.sfGridWrapperContent').append("<div class='sfButtonwrapper'><button type='button' id='btnContinueInStore'><span><span>" + getLocale(AspxCheckoutWithMultipleAddresses, 'Continue to Shopping') + "</span></span></button></div><div class='cssClassClear'></div></div></div></div>");
                        ...
                        <div class="cssClassHeader">
                            ...
                            <div class="cssClassHeaderRight">
                                <div class="sfButtonwrapper">
                                    <button type="button" id="btnEnterNewAddress">
                                        <span><span class="sfLocale">Enter a New Adddress</span></span></button>
                                </div>
                            </div>
                        ...
                        <div class="sfGridwrapper">
                            <div class="sfGridWrapperContent">
                                ...
                                <div class="sfButtonwrapper cssClassRight">
                                    <button type="submit" id="btnShippingAddressContinue">
                    ...
                    <div class="cssClassCommonBox Curve">
                        ...
                        <div class="sfGridwrapper">
                            <div class="sfGridWrapperContent">
                                ...
                                <div class="sfButtonwrapper cssClassRight">
                                    <button type="button" id="btnShippingBack">
                                        <span><span class="sfLocale">Back</span></span></button>
                                    <button type="submit" id="btnShippingContinue">
                                        <span><span class="sfLocale">Continue</span></span></button>
                                </div>
                                <div class="cssClassClear">
                                </div>
                    ...
                    <div class="cssClassCommonBox Curve">
                        ...
                        <div class="sfGridwrapper">
                            <div class="sfGridWrapperContent">
                                ...
                                <div class="sfButtonwrapper cssClassRight">
                                    <button type="button" id="btnBillingBack">
                                        <span><span class="sfLocale">Back</span></span></button>
                                    <button type="submit" id="btnBillingContinue">
                                        <span><span class="sfLocale">Continue</span></span></button>
                                </div>
                                <div class="cssClassClear">
                                </div>
