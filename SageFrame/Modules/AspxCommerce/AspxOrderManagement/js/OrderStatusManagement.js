        ...
        BindOrdersStatusInGrid: function(OrderSatatusName, isAct) {
            ...
            $("#tblOrderStatusDetails").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxOrderManagement,'AddedOn'), name: 'AddedOn', cssclass: 'cssClassHeadDate', controlclass: '', coltype: 'label', align: 'left', type: 'date', format: 'yyyy/MM/dd', hide: true },
                    ...
                    { display: getLocale(AspxOrderManagement,'IsActive'), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
            ...
            switch (tblID) {
                case "tblOrderStatusDetails":
                    ...
                    if (argus[7].toLowerCase() != "yes") {
                        ...
                        $("#chkIsActiveOrder").attr('disabled', 'disabled');
                        $("#chkIsReduceQuantity").attr('disabled', 'disabled');
