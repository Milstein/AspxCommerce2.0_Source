                ...
                <div class="sfButtonwrapper">
                    ...
                    <p>
                            ...
                            OnClick="ButtonOrder_Click" Text="Export to CSV" 
                                OnClientClick="OrderManage.ExportOrdersToCsvData()" 
...
<div class="cssClassCommonBox Curve" id="divOrderDetailForm" style="display:none">
    ...
    <div class="sfButtonwrapper">
        <p>
           ...
           <p>
            <button type="button" id="btnCreateShippingLabel">
                <span><span class="sfLocale">Create/View Shipping Label</span></span></button>
        </p>
    </div>
</div>
</div>
