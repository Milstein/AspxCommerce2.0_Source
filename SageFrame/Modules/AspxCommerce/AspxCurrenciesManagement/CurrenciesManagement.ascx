        ...
        <div class="cssClassHeader">
            ...
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                        <button type="button" id="btnAddNewCurrency">
                            <span><span class="sfLocale">Add New Currency</span></span></button>
                    </p>
                    <p>
                        <button type="button" id="btnRealTimeUpdate">
                            <span><span class="sfLocale">Real Time Update</span></span></button>
                    </p>
                    <p>
    ...
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfFormwrapper">
            <table id="tblEditCurrencyManage" border="0" class="cssClassPadding tdpadding" width="100%">
                ...
                <%--<tr>
                    <td>
                        <asp:Label ID="lblIsPrimaryForStore" runat="server" Text="Is Primary for Store:"
