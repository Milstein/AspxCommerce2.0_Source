...
$(function() {
    ...
    NotificationView = {
            ...
            if (data.d.length > 0) {
                ...
                $.each(data.d, function(index, item) {
                    if (item.NotificationTypeID == 3) {
                        //htmlc += "<li>" + getLocale(AspxNotification, "A new Customer has been registered on your shop") + "<br />" + getLocale(AspxNotification, "Customer Name:") + "<strong>" + item.CustomerID + "</strong><br /><a href=\"#" + "\">" + getLocale(AspxNotification, "See Customer Detail") + "</a></li>";
                ...
                if (nbc_notifs > 0) {
                    ...
                    // nbc_notifs = $("#list_customers_notif li").length;
                ...
                if (nbo_notifs > 0) {
                    ...
                    //nbo_notifs = $("#list_orders_notif li").length;
        ...
        init: function() {
            ...
            $("#lnkCustomerDetail").live("click", function() {
            ...
            $("#lnkShowAllCustomers").live("click", function() {
