            ...
            onComplete: function(e) {
                if (e) {
                    $.ajax({
                        ...
                        error: function() {
                            csscody.error('<h2>' + AspxCategoryManagement(AspxCategoryManagement, "Error Message") + '</h2><p>' + getLocale(AspxCategoryManagement, "Sorry! Failed to delete time.") + '</p>');
                        }
                    });
                }
            }
        };
        csscody.confirm("<h2>" + AspxCategoryManagement(AspxCategoryManagement, 'Delete Confirmation') + "</h2><p>" + getLocale(AspxCategoryManagement, 'Are you sure you want to delete this time?') + "</p>", properties);
    } else {
        if ($(obj).closest('div').find('span').length > 1) {
            $(obj).closest('span').remove();
        }
     ...
     categoryMgmt = {
         ...
         BindTreeCategory: function(data) {
             if (data.d.length > 0) {
                 ...
                 treeHTML += '</ul>';
                 treeHTML += '<div class="sfButtonwrapper"><p><button type="button" id="btnCatTreeSave" onclick="categoryMgmt.SaveChangesCategoryTree()"><span><span>Save Changes</span></span></button></p></div>'
                 ...
                 $('#categoryTree li').live('click', function() {
                     ...
                     $('.cssClassIsService').attr('disabled', 'disabled');
                     //categoryMgmt.ResetImageTab();
                     if (checkID != id) {
                         if (isServiceTypeBit[1].toLowerCase() == 'yes' || isServiceTypeBit[1].toLowerCase() == 'true') {
                             categoryMgmt.variables.isServiceType = true;
                             serviceBit = true;
                             categoryMgmt.GetCategoryByCagetoryID(id); //check service bit so placed in both condtion
...
//Password
         ...
         CropImage:function() {
             ...
             $("#btnCropForBanner").die().bind("click", function() {
                 ...
                 $.post(aspxCatModulePath + "FileUploader.aspx", { IsCropping: true, filePath: path, coOrdinates: coOrdinates, StoreID: storeId, PortalID: portalId, CultureName: cultureName }, function(ajaxFileResponse) {
                     ...
                     csscody.error('<h2>'+getLocale(AspxCategoryManagement, "Error Message")+'</h2><p>'+getLocale(AspxCategoryManagement, "Sorry! Failed to crop the image.")+'</p>');
        ...
        SaveCategory: function(formID) {
            ...
            var item_ids = categoryMgmt.GetAllCategoryItems(catID);
...
//                     $tabs.tabs('select', 5);
         ...
         CreateTabPanel: function(attGroup) {
             ...
             tabBody += '<p class="cssServiceProvidersSpan"><span class="cssServiceData cssAssignServiceProvider"  onclick="AssignServiceEmployee(this)"> <img  src="' + aspxTemplateFolderPath + '/images/admin/btnadduser.png" title="Assign Provider" alt="Assign Provider"/>Assign Provider</span>';
            ...
            // tabBody += '<button type="button" class="cssClassDeleteAssingProvider" onclick="DeleteAssignServiceProvider(this)">Remove Provider</button></div>';
             tabBody += '<span class="cssServiceData cssClassDeleteAssingProvider"  onclick="DeleteAssignServiceProvider(this)"> <img  src="' + aspxTemplateFolderPath + '/images/admin/commondeletebtn.png" title="Delete Provider" alt="Delete Provider"/>Delete Provider</span></p><div class="cssClassClear"></div>';
             ...
             tabBody += '<span class="cssServiceProviderDate"><p class="cssServiceData cssClassAddDateBtn" onclick="AddServiceDate(this);"><img src="' + aspxTemplateFolderPath + '/images/admin/imgadd.png" title="Add Date" alt="Add Date"/>Add Date</p><p class="cssServiceData cssClassDeleteServiceDate" onclick="DeleteServiceDate(this);"><img src="' + aspxTemplateFolderPath + '/images/admin/commondeletebtn.png" title="Delete Date" alt="Delete Date"/>Delete Date</p></span>';
           ...
           //  tabBody += '<button type="button" onclick="AddServiceTime(this);">Add Time</button><button type="button" onclick="DeleteServiceTime(this);">Delete</button>';
            tabBody += '<label class="cssServiceProviderTime"><p class="cssServiceData" onclick="AddServiceTime(this);"><img src="' + aspxTemplateFolderPath + '/images/admin/imgadd.png" title="Add Time" alt="Add Time"/>Add Time</p><p class="cssServiceData" onclick="DeleteServiceTime(this);"><img src="' + aspxTemplateFolderPath + '/images/admin/commondeletebtn.png" title="Delete Time" alt="Delete Time"/>Delete Time</p></label>';
             ...
             tabBody += '</td>';
             tabBody += '<td><p class="cssServiceData cssClassAddStoreBtn" onclick="AddMoreBranchService(this)"><img src="' + aspxTemplateFolderPath + '/images/admin/imgadd.png" title="Add Row" alt="Add Row"/></p></td>';
            ...
            // tabBody += '<td><span class="sfButtonwrapper"><button type="button" onclick="DeleteServiceRow(this)">Delete</button></span></td>';
             tabBody += '<td><p class="cssServiceData cssClassDeleteStoreBtn" onclick="DeleteServiceRow(this)"><img  src="' + aspxTemplateFolderPath + '/images/admin/commondeletebtn.png" title="Delete Row" alt="Delete Row" /></p></td>';
             tabBody += '</tr></tbody>';
             tabBody += '</table>';
             tabBody += '</br><span class="cssClassNote">Note: Later added date overlap previous same date value of same store.</span></div></div>';
             //}
             tabBody += '</div></li>';
             //END
             ...
             var buttons = '<div class="sfButtonwrapper"><p><button type="button" id="saveForm" onclick="categoryMgmt.submitForm(' + frmIDQuoted + ')"><span><span>Save</span></span></button> </p>';
             buttons += '<p><input id="categoryReset" type="reset" value="Reset" class="cssClassButtonSubmit" /></p><p><button type="button" id="btnDeleteCategory" onclick="categoryMgmt.DeleteCategory()" ><span><span>Delete</span></span></button></div><div class="cssClassClear"></div>';
             ...
             searchTable += '<td><div class="sfButtonwrapper cssClassPaddingNone"> <p><button type="button" onclick="categoryMgmt.SearchCategoryItems()"><span><span>Search</span></span></button></p></div></td></tr></table>';
