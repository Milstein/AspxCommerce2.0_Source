...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(".cssClassStore").live('click',function() {
        ...
        $.ajax({
            ...
            success: function(msg) {
                if (msg.d.length > 0 && msg.d != null) {
                    ...
                    $("#lblTotalResultCount").html('<b>' + msg.d.length +'&nbsp'+getLocale(AspxStoreLocator,'Stores Found')+'</b><br/>');
                    if (msg.d.length > 1) {
    ...
    function createSidebarEntry(marker, name, description, street, Locality, City, State, Country, ZIP, StoreID, PortalID, index) {
        ...
        html += "<br/>";
       // html += "<br/><li id=\"changelocation\">";
     //  html += " <div class=\"cssClassEditStore\">" + getLocale(AspxStoreLocator, "Edit Store") + "</div></li>";

        html += " <div class=\"cssClassEditStore sfButtonwrapper\"><button type=\"button\" onclick=\"UpdateLocation('" + name + "','" + description + " ','" + street + " ','" + Locality + " ','"
            + City + "','" + State + "','" + Country + "', " + ZIP + "," + StoreID + "," + index + ");\" ><span><span>" + getLocale(AspxStoreLocator, "Edit Store") + "</span></span></button></div>";
      //  html += "</li>";
    ...
    <table cellpadding="4" cellspacing="8">
        <tr>
            <td valign="top">
                ...
                <div id="sidebarstore" class="cssClassStoreSideBar">
                </div>
            </td>
            <td valign="top">
                <label class="cssClassLabel sfLocale" id="lblHelp">
                    <b>Click on icon for more information.</b></label>
                                ...
                                <div class="sfGridWrapperContent">
                                    <div class="sfFormwrapper">
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <label class="cssClassLabel sfLocale">Store Name:</label><span class="cssClassRequired">*</span>
                                                  
                                                </td>
                                                <td>
                                                  <input type="text" id="txtStoreName" class="sfInputbox" /><span id="nameErrorLabel"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                 <input type="text" id="txtStoreDescription" class="sfInputbox" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblLatitude" runat="server" Text="Latitude:" 
                                                        CssClass="cssClassLabel" meta:resourcekey="lblLatitudeResource1"></asp:Label>
                                                </td>
                                                <td>
                                                    <input id="txtLatitude" type="text" name="latitude" class="sfInputbox " />
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblLongitude" runat="server" Text="Longitude:" 
                                                        CssClass="cssClassLabel" meta:resourcekey="lblLongitudeResource1"></asp:Label>
                                                </td>
                                                <td>
                                                    <input id="txtLongitude" type="text" name="longitude" class="sfInputbox " />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblStreet" runat="server" Text="Street:" 
                                                        CssClass="cssClassLabel" meta:resourcekey="lblStreetResource1"></asp:Label>
                                                </td>
                                                <td>
                                                    <input id="txtStreet" type="text" name="street" class="sfInputbox " />
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblLocalityName" runat="server" Text="Locality Name:" 
                                                        CssClass="cssClassLabel" meta:resourcekey="lblLocalityNameResource1"></asp:Label>
                                                </td>
                                                <td>
                                                    <input id="txtLocalityName" type="text" name="localityName" class="sfInputbox " />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input id="txtCity" type="text" name="city" class="sfInputbox " />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input id="txtState" type="text" name="state" class="sfInputbox " />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input id="txtCountry" type="text" name="country" class="sfInputbox " />
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblZip" runat="server" Text="ZIP:" CssClass="cssClassLabel" 
                                                        meta:resourcekey="lblZipResource1"></asp:Label>
                                                </td>
                                                <td>
                                                    <input id="txtZIP" type="text" name="zip" class="sfInputbox " />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
