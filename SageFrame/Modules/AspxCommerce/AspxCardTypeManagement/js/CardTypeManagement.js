    ...
    cardTypeMgmt = {
        ...
        BindCardTypeInGrid: function(cardTypeName, isAct) {
            ...
            $("#tblCardTypeDetails").sagegrid({
                ...
                colModel: [
                        ...
                        { display: getLocale(AspxCardTypeManagement, "Is System Used"), name: 'Is_System_Used', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
				        { display: getLocale(AspxCardTypeManagement, "IsActive"), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
            ...
            switch (tblID) {
                ...
                case "tblCardTypeDetails":
                    if (argus[4].toLowerCase() != "yes") {
                        ...
                        $("#chkIsActiveCardType").attr('checked', cardTypeMgmt.Boolean(argus[5]));
        ...
        SaveCardType: function(CardTypeId) {
            ...
            var cardTypeSaveObj = {
                ...
                IsActive: $("#chkIsActiveCardType").attr('checked'),
