<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BookAppointmentManage.ascx.cs" Inherits="Modules_AspxCommerce_AspxBookAnAppointment_BookAppointmentManage" %>
...
<div id="divBookAppointManage">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblBookAppointmentHeader" runat="server" 
             ...
             <div class="cssClassHeaderRight">
                 <div class="sfButtonwrapper">
                     <p>
                         <button type="button" id="btnDeleteSelectedAppointment">
                             <span><span class="sfLocale">Delete All Selected</span></span></button>
                     </p>
                     <p>
                         <asp:Button ID="btnExportToExcel" class="cssClassButtonSubmit" runat="server" Text="Export to Excel"
                             OnClientClick="AppointmentManage.ExportDivDataToExcel()" 
                     ...
                     <p>
                         <asp:Button ID="btnExportToCsv" runat="server" class="cssClassButtonSubmit" Text="Export to CSV"
                             OnClientClick="AppointmentManage.ExportToCsvData()" 
         ...
         <div class="sfGridwrapper">
              <div class="sfGridWrapperContent">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="160">
                                ...
                                <select id="ddlAppointmentStatus" class="sfListmenu">
                            ...
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" id="btnSearchAppointment">
                ...
                <table id="tblBookAppointment" width="100%" border="0" cellpadding="0" cellspacing="0">
                 ...
                 <table id="tblAppointmentExportData" cellspacing="0" cellpadding="0" border="0" width="100%" style="display:none">
                </table>
                  </div>
           </div>
    </div>
...
<div id="appointmentMainDiv" class="cssClassCommonBox Curve" style="display: none">
    <div class="cssClassAppointmentcontainer">
        <div id="" class="cssClassAppointmentContent">
            ...
            <div class="sfFormwrapper">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td colspan="2">
                                <h3><asp:Label runat="server" Text="Appointment for Order ID:" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblAppointmentStatus" runat="server" Text="Appointment Status:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblAppointmentStatusResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblServiceName" runat="server" Text="Service Name:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblServiceNameResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblProductName" runat="server" Text="Product Name:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblProductNameResource1"></asp:Label>
                            </td>
                            <td>
                            ...
                            <tr>
                            <td>
                                <asp:Label ID="lblProductDuration" runat="server" Text="Service Duration:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblProductDurationResource1"></asp:Label>
                            </td>
                            <td>
                         ...
                         <tr>
                            <td>
                                <asp:Label ID="lblPrice" runat="server" Text="Price:" CssClass="cssClassLabel" 
                                    meta:resourcekey="lblPriceResource1"></asp:Label>
                            </td>
                            <td>
                               <input type="text" id="txtPrice" name="Price" class="sfInputbox cssClassFormatCurrency cssClassDisable" style="text-align: left"/>
                           </td>
                        </tr>
                         <tr>
                            <td>
                                <asp:Label ID="lblStoreLocation" runat="server" Text="Store Location:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblStoreLocationResource1"></asp:Label>
                            </td>
                            <td>
                                <select id="ddlStoreLocation" class="sfListmenu">
                                     <option value="0" class="sfLocale">- All -</option>
                                </select><span id="storeLocationError"></span>
                                <input type="button"  id="btnResetData" value="Reset" style="display: none"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblServiceProviderName" runat="server" Text="Service Provider Name:" 
                                    ...
                                    meta:resourcekey="lblServiceProviderNameResource1"></asp:Label>
                            </td>
                            <td>
                         ...
                         <tr>
                            <td>
                                <asp:Label ID="lblPreferredDate" runat="server" Text="Service Date:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblPreferredDateResource1"></asp:Label>
                            </td>
                            <td>
                                <input type="text" id="txtPreferredDate" name="PreferredDate" class="sfInputbox"/>
                                <label id="lblAvailableDateError" class="cssClassRequired"></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblPreferredTime" runat="server" 
                                    Text="Provider Availability:" CssClass="cssClassLabel cssClassDisable" 
                            ...
                            <td>
                                ...
                                <label id="lblTimeError"></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="lblPreferredTimeInterval" runat="server" 
                                    Text="Appointment Time:" CssClass="cssClassLabel" 
                                    meta:resourcekey="lblPreferredTimeIntervalResource1"></asp:Label>
                            </td>
                            <td>
                                <input type="text" id="txtPreferredTimeInterval" name="PreferredTimeInterval" class="sfInputbox cssClassDisable"/>
                            <label id="lblBookTimeIntervalError"></label>
                            </td>
                        </tr>
                         <tr>
                            <td>
                                <asp:Label ID="lblPaymentMethodType" runat="server" Text="Payment Method:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblPaymentMethodTypeResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTitle" runat="server" Text="Title:" CssClass="cssClassLabel" 
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblLastName" runat="server" Text="Last Name:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblLastNameResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblGender" runat="server" Text="Gender:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblGenderResource1"></asp:Label><span class="cssClassRequired">*</span>
                            </td>
                            <td id="chkGender">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblMobileNumber" runat="server" Text="Mobile Number:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblMobileNumberResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblPhoneNumber" runat="server" Text="Telephone Number:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblPhoneNumberResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblEmailID" runat="server" Text="Email ID:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblEmailIDResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblTypeOfTreatment" runat="server" Text="Type Of Treatment:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblTypeOfTreatmentResource1"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblCustomerType" runat="server" Text="Type Of Customer:" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblCustomerTypeResource1"></asp:Label><span class="cssClassRequired">*</span>
                            </td>
                            <td id="customerType">
                                <label class="sfLocale">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblMembershipElite" runat="server" Text="Membership Elite" 
                                    CssClass="cssClassLabel" meta:resourcekey="lblMembershipEliteResource1"></asp:Label><span class="cssClassRequired">*</span>
                            </td>
            ...
            <div class="sfButtonwrapper">
                <p>
                    <button type="button" id="btnUpdateAppointment">
