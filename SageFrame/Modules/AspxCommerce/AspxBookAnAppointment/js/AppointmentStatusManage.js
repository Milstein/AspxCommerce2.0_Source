        ...
        BindAppointmentStatusInGrid: function(appontmentStatusName, isActive) {
            ...
            $("#tblAppointmentStatusDetails").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxBookAnAppointment, "Used In System"), name: 'IsSystemUsed', cssclass: '', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
                ...
                buttons: [{ display: 'Edit', name: 'edit', enable: true, _event: 'click', trigger: '1', callMethod: 'AppointmentStatusMgmt.EditAppointmentStatus', arguments: '1,2' },
               ],
                rp: perpage,
