<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BookAppointment.ascx.cs"
    Inherits="Modules_AspxCommerce_AspxBookAnAppoinment_BookAppointment" %>
            ...
            <div id="dvPlaceOrder" class="cssClassOrderReview">
                <div class="sfButtonwrapper ">
                    <%-- <button id="btnPlaceBack" type="button" value="back" class="back">
                            <span><span class="sfLocale">Back</span></span></button>--%>
                    <button id="btnPlaceOrder" type="button" class="submit">
                        <span><span class="sfLocale">Place Order</span></span></button>
                </div>
            </div>
        </div>
    </div>
