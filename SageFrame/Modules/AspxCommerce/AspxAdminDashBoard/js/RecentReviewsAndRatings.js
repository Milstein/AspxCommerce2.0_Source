...
$(function() {
    ...
    recentReviewsAndRatings = {
        ...
        BindAverageUserRating: function(item) {
            ...
            userRatings += '<div class="cssClassRatingInfo"><p>' + Encoder.htmlDecode(item.ReviewSummary) + '<span>' + getLocale(AspxAdminDashBoard, "Review by: ") + '<strong>' + item.Username + '</strong></span></p></div></div>';
            ...
            userRatings += '</div><div class="sfButtonwrapper"><p><button type="button" id="btnEditReview" onclick="recentReviewsAndRatings.EditReview(' + item.ItemReviewID + ' )"><span><span>Edit</span></span></button></p></div></td></tr>';
        ...
        SaveItemRatings: function() {
            ...
            //this.config.data = JSON2.stringify({ ratingCriteriaValue: ratingValue, statusID: statusId, summaryReview: summaryReview, review: review, itemReviewID: itemReviewID, viewFromIP: userIP, viewFromCountry: countryName, itemID: itemId, nickName: nickName, aspxCommonObj: aspxCommonObj });
