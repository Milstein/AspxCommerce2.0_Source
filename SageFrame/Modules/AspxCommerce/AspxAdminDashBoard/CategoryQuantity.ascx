    ...
    $(function () {
        ...
        var categoryStatic = function () {
            ...
            var drawPieChartRevenue = function (list) {
                ...
                var data = datas;
                //var data = datas;//['Orders', s1], ['Customer Registration', s2]
                if (data.length > 0) {
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot('dvCatRev', [data], { title: '', seriesDefaults: { shadow: true, renderer: jQuery.jqplot.PieRenderer, rendererOptions: { showDataLabels: true} }, legend: { show: true }, cursor: { show: false} });
                }
            };
            ...
            var drawPieChartTopCatBySell = function (list) {
                ...
                if (data.length > 0) {
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot('dvCatSellReport', [data], { title: '', seriesDefaults: { shadow: true, renderer: jQuery.jqplot.PieRenderer, rendererOptions: { showDataLabels: true } }, legend: { show: true }, cursor: { show: false } });
                }
            };
            var getTopCategoryByItemSell = function () {
                ...
                // GetTopRefundReason GetTotalRefund
            };
        ...
        <ul>
            <li><a href="#fragment-10">
                <asp:Label ID="lblTopCategorySell" runat="server" 
                    Text="Top Category By Most Ordered Item " 
                    meta:resourcekey="lblTopCategorySellResource1"></asp:Label>
            </a></li>
            <li><a href="#fragment-11">
                <asp:Label ID="lblTopCategoryByRevenue" runat="server" 
                    Text="Top Category By Highest Revenue" 
                    meta:resourcekey="lblTopCategoryByRevenueResource1"></asp:Label>
            </a></li>
        </ul>
        <div id="fragment-10">
            ...
            <div class="cssClassCommonBox Curve">
                ...
                <div class="sfFormwrapper">
                    <div class="classTableWrapperOuter">
                        ...
                        <p class="sfClassNote">
                            <span class="sfLocale sfClassBold">Note:</span> <span class="sfLocale">Revenue is calculated from Net product purchased price(without
                            discounts) and quantity.</span>
                        </p>
                    </div>
                </div>
            </div>
