        ...
        var visitor = function () {
            ...
            var drawPieChartNewAccountStatics = function (s1, s2) {
                ...
                if (s1 > 0 && s2 > s1 != null && s2 != null) {
                    ...
                    $("#dvVisitorAccount").html('');
                    var data = [['TotalVisit', s1], ['TotalCustomer', s2]];

                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot('dvVisitorAccount', [data], { title: '', seriesDefaults: { shadow: true, renderer: jQuery.jqplot.PieRenderer, rendererOptions: { showDataLabels: true } }, legend: { show: true }, cursor: { show: false } });
                }
            };
            ...
            var drawPieChartVisitorsOrder = function (s1, s2) {
                ...
                if (s1 > 0 && s2 > s1 != null && s2 != null) {
                    $('#dvVisitorOrder').show();
                    $("#dvVisitorOrder").html('');
                    var data = [['TotalVisit', s1], ['TotalOrder', s2]];
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot('dvVisitorOrder', [data], { title: '', seriesDefaults: { shadow: true, renderer: jQuery.jqplot.PieRenderer, rendererOptions: { showDataLabels: true} }, legend: { show: true }, cursor: { show: false} });
            ...
            var drawPieChartVisitorsNewOrder = function (s1, s2) {
                ...
                if (s1 > 0 && s2 > s1 != null && s2 != null) {
                    ...
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot.config.enablePlugins = true;
                    jQuery.jqplot('dvNewAccountNewOrder', [data], { title: '', seriesDefaults: { shadow: true, renderer: jQuery.jqplot.PieRenderer, rendererOptions: { showDataLabels: true} }, legend: { show: true }, cursor: { show: false} });
                }
            };
    ...
    <div id="container-x">
        <ul>
            <li><a href="#fragment-1">
                <asp:Label ID="lblVisitor" runat="server" Text="Order Made By All Visitors " meta:resourcekey="lblVisitorResource1" 
                    ></asp:Label>
            </a></li>
            <li><a href="#fragment-2">
                <asp:Label ID="lblNewAccount" runat="server" 
                    Text="New Account Created By Visitor" meta:resourcekey="lblNewAccountResource1" 
                   ></asp:Label>
            </a></li>
             <li><a href="#fragment-3">
                <asp:Label ID="lblNewAccountOrder" runat="server" 
                     Text="Order Made By New Account" meta:resourcekey="lblNewAccountOrderResource1" 
                   ></asp:Label>
            </a></li>
        </ul>
        ...
        <div class="sfFormwrapper">
            <div class="classTableWrapperOuter">
                ...
                <div class="sfHighlight">
                  ...
                  <strong>  <label class="sflabel" id="lblVisitorOrderRate">
                        0%</label></strong>
                </div>
            </div>
        </div>
        ...
        <div class="sfFormwrapper">
            <div class="classTableWrapperOuter">
                ...
                <div class="sfHighlight">
                 ...
                 <strong>   <label class="sfLabel" id="lblVisitorAccount">
                        0%</label></strong>
                </div>
            </div>
        </div>
        ...
        <div class="sfFormwrapper">
            <div class="classTableWrapperOuter">
                ...
                <div class="sfHighlight">
                   ...
                   <strong> <label class="sfLabel" id="lblNewAccountNewOrder">
                        0%</label></strong>
                </div>
            </div>
        </div>
