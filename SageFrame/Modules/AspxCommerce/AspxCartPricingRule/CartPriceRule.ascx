        ...
        <div class="cssClassTabPanelTable">
            <div id="CartPriceRule-TabContainer" class="cssClassTabpanelContent">
                ...
                <div id="CartPriceRule-1" class="sfFormwrapper">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            <td>
                                <span id="CartPriceRule-lblFromDate" class="cssClassLabel sfLocale">From Date:</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span id="CartPriceRule-lblToDate" class="cssClassLabel sfLocale">To Date:</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span id="CartPriceRule-lblIsActive" class="cssClassLabel sfLocale">Is Active:</span>
                            </td>
                            <td>
                ...
                <div id="CartPriceRule-2">
                    <div class="cssClassFieldSet sfLocale">
                        <h2 class="sfLocale">
                ...
                <div id="CartPriceRule-3" class="sfFormwrapper">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tdbordernone">
                        ...
                        <tr>
                            <td class="cssClassTableLeftCol">
                                <span id="CartPriceRule-lblDiscountQuantity" class="cssClassLabel sfLocale">Maximum Qty Discount
                                    is Applied To:</span>
                            </td>
                            <td>
                        ...
                        <tr style="display:none;" id="trBuyX" >
                            <td class="cssClassTableLeftCol">
                                <span id="CartPriceRule-lblDiscountStep" class="cssClassLabel sfLocale">Discount Qty Step (Buy
                                    X):</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="cssClassTableLeftCol">
                                <span id="CartPriceRule-lblApplytoShippingAmount" class="cssClassLabel sfLocale">Apply To Shipping
                                    Amount:</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="cssClassTableLeftCol">
                                <span id="CartPriceRule-lblFurtherRuleProcessing" class="cssClassLabel sfLocale">Further Rule
                                    Processing:</span>
                            </td>
                            <td>
            ...
            <div class="sfButtonwrapper">
                ...
                <p>
                    <button type="button" id="btnAddCartPricingRule" >
                        <span class="sfLocale">Add Pricing Rule</span></button>
                </p>
                <div class="cssClassClear">
                </div>
            </div>
                            ...
                            <div class="sfButtonwrapper cssClassPaddingNone">
                                <p>
                                    <button type="button" onclick="cartPriceRuleFormat.SearchCartPricingRule()">
                                        <span class="sfLocale">Search</span></button>
                                </p>
                            </div>
                        </td>
                    </tr>
