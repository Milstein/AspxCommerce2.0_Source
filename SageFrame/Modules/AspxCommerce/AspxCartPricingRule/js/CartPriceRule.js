         ...
         GetCartPricingRules: function(ruleNm, startDt, endDt, isAct) {
             ...
             $("#gdvCartPricingRules").sagegrid({
                 ...
                 colModel: [
                     ...
                     { display: getLocale(AspxCartPricingRule, "From Date"), name: 'FromDate', cssclass: 'cssClassHeadDate', controlclass: '', coltype: 'label', align: 'left', type: 'date', format: 'yyyy/MM/dd' },
                     { display: getLocale(AspxCartPricingRule, "To Date"), name: 'ToDate', cssclass: 'cssClassHeadDate', controlclass: '', coltype: 'label', align: 'left', type: 'date', format: 'yyyy/MM/dd' },
                     { display: getLocale(AspxCartPricingRule, "Is Active"), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', type: 'boolean', format: 'True/False', align: 'left' },
...
//                 $(obj).parent().parent('SPAN').find("input.input-text").after('<span class="cssValidationError" style="color:Red;">*Please Enter Data<span>');
...
//              }    
         ...
         ConditionSelected: function(self) {
             ...
             if ($(self).val() == "41") {
                 ...
                 // $(self).closest('li').parent().find('input[value="41"]').parent('li').find('select option[value="7"]').remove();
                 // $(self).closest('li').parent().find('input[value="41"]').parent('li').find('select option[value="8"]').remove();
                 cartPriceRuleFormat.Delete(self);
             }
             if ($(self).val() == "42") {
                 $("#CartPricingRuleTemplate_" + $(self).val()).render(ruleInfo).appendTo($(self).closest('li').parent());
                 $("#CartPricingRuleTemplate_plus_Master").render(ruleInfo).appendTo($(self).closest('li').parent());
                 // $(self).closest('li').parent().find('input[value="42"]').parent('li').find('select option').not('option[value="1"],option[value="2"]').remove();
                 // $(self).closest('li').parent().find('input[value="42"]').parent('li').find('select option[value="8"]').remove();
                 cartPriceRuleFormat.Delete(self);
             }
             if ($(self).val() == "43") {
                 $("#CartPricingRuleTemplate_" + $(self).val()).render(ruleInfo).appendTo($(self).closest('li').parent());
                 $("#CartPricingRuleTemplate_plus_Master").render(ruleInfo).appendTo($(self).closest('li').parent());
                 // $(self).closest('li').parent().find('input[value="43"]').parent('li').find('select').find('option[value="7"],option[value="8"]').remove();
                 cartPriceRuleFormat.Delete(self);
             }
                 //        if ($(self).val() == "40") {
                 //            $("#CartPricingRuleTemplate_" + $(self).val()).render(ruleInfo).appendTo($(self).closest('li').parent());
                     ...
                     for (var d = 0; d < ruleCondition.LstCartPriceRuleConditions[0].LstCartConditionDetails.length; d++) {
                         ...
                         if (attr_ID == "0") {
                             ...
                             if (arrCategoryID != "") {
                                 ...
                                 $(self).parents('ul:eq(0)').find('div.pricingRuleCategoryList:eq(' + catIndex_1 + ')').parents('.cssClassOnClick').find('.cssClassFieldSetLabel').attr('title', arrCategoryID);
                                 catIndex_1++;
                             } else {
                     ...
                     for (var d = 0; d < ruleCondition.LstProductAttributeRuleConditions[0].LstCartConditionDetails.length; d++) {
                         ...
                         if (attr_ID == "0") {
                             ...
                             if (arrCategoryID != "...") {
                                 ...
                                 $(self).parents('ul:eq(0)').find('div.pricingRuleCategoryList:eq(' + catIndex_2 + ')').parents('.cssClassOnClick').find('.cssClassFieldSetLabel').attr('title', arrCategoryID);
                                 catIndex_2++;
                                 //$(self).parents('ul:eq(0)').find('div.pricingRuleCategoryList').parents('.cssClassOnClick').find('.cssClassFieldSetLabel').text(catName);
                                 //$(self).parents('ul:eq(0)').find('div.pricingRuleCategoryList').parents('.cssClassOnClick').find('.cssClassFieldSetLabel').attr('title', arrCategoryID);
                     ...
                     for (var d = 0; d < ruleCondition.LstProductSublectionRuleConditions[0].LstCartConditionDetails.length; d++) {
                         ...
                         if (attr_ID == "0") {
                             ...
                             if (arrCategoryID != "") {
                                 ...
                                 $(self).parents('ul:eq(0)').find('div.pricingRuleCategoryList:eq(' + cat_index + ')').parents('.cssClassOnClick').find('.cssClassFieldSetLabel').attr('title', arrCategoryID);
                                 cat_index++;
                                 //$(self).closest('li').parent('ul').find('div.pricingRuleCategoryList').parent().parent().find('a.cssClassFieldSetLabel').text(catName.join(','));
                                 // $(self).closest('li').parent('ul').find('div.pricingRuleCategoryList').parent().parent().find('a.cssClassFieldSetLabel').attr('title', arrCategoryID);
