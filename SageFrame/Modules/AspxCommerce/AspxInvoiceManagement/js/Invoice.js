...
$(function() {
    ...
    invoiceMgmt = {
        ...
        LoadInvoiceAjaxStaticImage: function() {
            $('#imgStoreLogo').attr('src', AspxCommerce.utils.GetAspxRootPath() + storeLogoUrl.replace('uploads', 'uploads/Small'));
        },
        ...
        GetInvoiceDataForExport: function() {
            ...
            invoiceObj.BillToName = null;
            invoiceObj.OrderStatusName = null;
            this.config.url = this.config.baseURL + "GetInvoiceDetailsList";
            this.config.data = JSON2.stringify({ offset: 1, limit: null, invoiceObj: invoiceObj, aspxCommonObj: aspxCommonObj });
        ...
        BindInvoiceDataForExport: function(msg) {
            var exportData = '<thead><tr><th>' + getLocale(AspxInvoiceManagement, 'Invoice No.') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Invoice Date') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Order ID') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Customer Name') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Order Date') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Bill to Name') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Ship to Name') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Status') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Amount') + '</th><th>' + getLocale(AspxInvoiceManagement, 'Customer Email') + '</th></tr><tbody>';
            if (msg.d.length > 0) {
                $.each(msg.d, function(index, value) {
                    ...
                    exportData += '<td>' + curSymbol + ' ' + value.Amount + '</td><td>' + value.CustomerEmail + '</td></tr>';
                });
            } else {
                exportData += '<tr><td>' + getLocale(AspxInvoiceManagement, 'No Records Found!') + '</td></tr>';
            }
            exportData += '</tbody>';
        ...
        BindInvoiceInformation: function(invoiceNum, billToName, statusType) {
            ...
            $("#gdvInvoiceDetails").sagegrid({
                ...
                param: invoiceData, //{ invoiceNumber: invoiceNum, billToName: billToName, status: statusType, storeID: storeId, portalID: portalId, userName: userName, cultureName: cultureName },
                current: current_,
                pnew: offset_,
                    ...
                    if (index == 0) {
                        ...
                        if (item.IsMultipleShipping != true) {
                            ...
                            if (item.ShippingName != '') {
                                ...
                                if (item.ItemTypeId == 2) {
                                    ...
                                    // span1 += "<br/><b>Shipping Address do not needed for Service type Items</b>";
                                    span1 += "<li><b>" + getLocale(AspxInvoiceManagement, 'Shipping Address do not needed for Service type Items') + "</b></li>";
                                } else {
                                    //span1 += "<br/><b>Shipping Address is not available</b>";
                            ...
                            if (index == 0) {
                                ...
                                //  itemOrderDetails += "<tr><td class='cssClassItemName cssNoData'>&nbsp;</td><td class='cssClassShippingMethod cssNoData'>&nbsp;</td><td class='cssClassShippingAddress cssNoData'>&nbsp;</td><td class='cssClassPrice cssNoData'>&nbsp;</td><td class='cssClassLabel cssClassQuantity'><b>Sub Total :</b></td>";
                                //  itemOrderDetails += " <td class='cssClassAlignRight'><span class='cssClassFormatCurrency cssClassSubTotal' >" + item.GrandSubTotal.toFixed(2) + "</span></td></tr>";
                                ...
                                //  itemOrderDetails += "<tr><td class='cssClassItemName cssNoData'>&nbsp;</td><td class='cssClassPrice cssNoData'>&nbsp;</td><td class='cssClassLabel cssClassQuantity'><b>Taxes:</b></td>";
                        ...
                        itemOrderDetails = '<table class="OrderDetailsTable" width="100%" border="0" cellspacing="0" cellpadding="0"><thead><tr align="left" class="cssClassLabel"><th class="cssClassItemID cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, "Item ID") + '</b></th><th class="cssClassItemSku cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Item SKU') + '</b></th><th class="cssClassItemName cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Item Name') + '</b></th><th class="cssClassShippingMethod cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Shipping Method') + '</b></th><th class="cssClassShippingAddress cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Shipping To') + '</b></th><th class="cssClassQuantity cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Quantity') + '</b></th><th class="cssClassPrice cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Unit Price') + '</b></th><th class="cssClassSubTotal cssClassTDHeading"><b>' + getLocale(AspxInvoiceManagement, 'Line Total') + '</b></th></td></tr></thead><tbody>';
                            ...
                            if (index == 0) {
                                ...
                                //  itemOrderDetails += "<tr><td class='cssClassItemName cssNoData'>&nbsp;</td><td class='cssClassShippingMethod cssNoData'>&nbsp;</td><td class='cssClassShippingAddress cssNoData'>&nbsp;</td><td class='cssClassPrice cssNoData'>&nbsp;</td><td class='cssClassLabel cssClassQuantity'><b>Taxes:</b></td>";
                                //  itemOrderDetails += " <td class='cssClassAlignRight'><span class='cssClassFormatCurrency cssClassSubTotal' >" + item.TaxTotal.toFixed(2) + "</span></td></tr>";
                                itemOrderDetails += "<tr><td class='cssClassItemID cssNoData'>&nbsp;</td><td class='cssClassItemSku cssNoData'>&nbsp;</td><td class='cssClassItemName cssNoData'><p>&nbsp;</p></td><td class='cssClassShippingMethod cssNoData'>&nbsp;</td><td class='cssClassShippingAddress cssNoData'>&nbsp;</td><td class='cssClassQuantity cssNoData'>&nbsp;</td><td class='cssClassLabel cssClassPrice'><b>" + getLocale(AspxInvoiceManagement, 'Shipping Cost :') + "</b></td>";
                                itemOrderDetails += " <td class='cssClassAlignRight'><span class='cssClassFormatCurrency cssClassSubTotal' >" + item.TotalShippingCost.toFixed(2) + "</span></td></tr>";
                                itemOrderDetails += "<tr><td class='cssClassItemID cssNoData'>&nbsp;</td><td class='cssClassItemSku cssNoData'>&nbsp;</td><td class='cssClassItemName cssNoData'><p>&nbsp;</p></td><td class='cssClassShippingMethod cssNoData'>&nbsp;</td><td class='cssClassShippingAddress cssNoData'>&nbsp;</td><td class='cssClassQuantity cssNoData'>&nbsp;</td><td class='cssClassLabel cssClassPrice'><b>" + getLocale(AspxInvoiceManagement, 'Coupon Amount :') + "</b></td>";
        ...
        GenerateInvoicePDF: function() {
            var invoceDetailInfo = {
                headerInfo: {
                    ...
                    BillingAddress: JSON2.stringify(billingAddress), //$('#divBillingAddressInfo').html(),
                    ShippingAddress: JSON2.stringify(shippingAddress)// $('#divShippingAddressInfo').html()
                },
                tableDataInfo: {
                    ItemId: '',
                    SKU: '',
            ...
            $('#divOrderItemDetails tr ').each(function() {
                ...
                invoceDetailInfo.tableDataInfo.ImagePath = $(this).find('.cssClassItemName b').length > 0 ? null : $(this).find('.cssClassItemName span img ').attr('src');
                ...
                invoceDetailInfo.tableDataInfo.Price = $(this).find('.cssClassPrice b').length > 0 ? $(this).find('.cssClassPrice b').html() : $(this).find('.cssClassPrice').html(); //.replace("&nbsp;", "");
        ...
        EmailInvoice: function(e) {
            if (e) {
                ...
                this.config.url = this.config.baseURL + "NotifyOrderStatusUpdate";
