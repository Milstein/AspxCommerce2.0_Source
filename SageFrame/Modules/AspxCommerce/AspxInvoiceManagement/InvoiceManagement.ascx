            ...
            <div class="cssClassHeader">
                <h1>
                    <asp:Label ID="lblInvoiceHeading" runat="server" Text="Invoices" 
                        meta:resourcekey="lblInvoiceHeadingResource1"></asp:Label>
                </h1>
...
<div id="divInvoiceForm" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblInvoiceForm" runat="server" 
                    meta:resourcekey="lblInvoiceFormResource1"></asp:Label>
            </h2>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnSavePDFForm2" runat="server" Text="Save As Pdf" OnClick="btnSavePDFForm2_Click"
                            OnClientClick="invoiceMgmt.GenerateInvoicePDF()" 
                    ...
                    <p>
                        <button type="button" id="btnEmail">
                            <span><span class="sfLocale">Email</span></span></button>
                    </p>
                    <div class="cssClassClear">
                    </div>
                </div>
        ...
        <div id="divPrintInvoiceForm" class="sfFormwrapper">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    ...
                    <td><br />
                       <b><asp:Label ID="lblInvoiceNo" runat="server" Text="Invoice No: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblInvoiceNoResource1"></asp:Label></b><span
                ...
                <tr>
                    <td>
                        <b><asp:Label ID="lblStoreName" runat="server" Text="Store Name: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblStoreNameResource1"></asp:Label></b><span
                            id="spanStoreName"></span><br />
                        <b><asp:Label ID="lblStoreDescription" runat="server" 
                            Text="Store Description: " CssClass="cssClassLabel" 
                            meta:resourcekey="lblStoreDescriptionResource1"></asp:Label></b><span
                            id="spanStoreDescription"></span><br />
                        <b><asp:Label ID="lblCustomerName" runat="server" Text="Customer Name: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblCustomerNameResource1"></asp:Label></b><span
                            id="spanCustomerName"></span><br />
                        <b><asp:Label ID="lblCustomeEmail" runat="server" Text="Customer Email: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblCustomeEmailResource1"></asp:Label></b><span
                            id="spanCustomerEmail"></span>
                    </td>
                    <td>
                        <b><asp:Label ID="lblOrderID" runat="server" Text="Order ID: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblOrderIDResource1"></asp:Label></b><span
                            id="spanOrderID"></span>
                        <br />
                        <b><asp:Label ID="lblOrderDate" runat="server" Text="ORDER DATE: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblOrderDateResource1"></asp:Label></b>
                        <span id="spanOrderDate"></span>
                        <br />
                        <b><asp:Label ID="lblOrderStatus" runat="server" Text="STATUS: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblOrderStatusResource1"></asp:Label></b><span
                            id="spanOrderStatus"></span>
                        <br />
                        <b><asp:Label ID="lblPaymentMethod" runat="server" Text="PAYMENT METHOD: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblPaymentMethodResource1"></asp:Label></b><span
                            id="spanPaymentMethod"></span>
                        <br />
                        <b><asp:Label ID="lblShippingMethod" runat="server" Text="SHIPPING METHOD: " 
                            CssClass="cssClassLabel" meta:resourcekey="lblShippingMethodResource1"></asp:Label></b><span
