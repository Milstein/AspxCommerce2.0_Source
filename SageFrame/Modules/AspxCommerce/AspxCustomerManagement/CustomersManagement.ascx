...
<div class="cssClassCommonBox Curve">
    <div class="cssClassHeader">
        <h1>
            <asp:Label ID="lblAttrGridHeading" runat="server" Text="Manage Customers" 
            ...
            <div class="sfButtonwrapper">
                <p>
                    <button type="button" id="btnAddNewCustomer">
                        <span><span class="sfLocale">Add New Customer</span></span>
                    </button>
                </p>
                <p>
...
<div id="divAddNewCustomer" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblCustomerHeading" runat="server" Text="Add New Customer" 
                    meta:resourcekey="lblCustomerHeadingResource1"></asp:Label>
            </h2>
        </div>
<div class="cssClassUserRegistrationPage">
    <div class="cssClassUserRegistration" >
        ...
        <div id="divRegistration" runat="server">
            ...
            <span class="cssClassRequired sfLocale">Fields marked with <b>*</b> are compulsory. </span>
                    ...
                    <tr>
                        <td width="270">
                            <asp:Label ID="FirstNameLabel" runat="server" AssociatedControlID="FirstName" 
                                CssClass="sfFormlabel" meta:resourcekey="FirstNameLabelResource1" 
                                Text="First Name: "></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="FirstName" runat="server" 
                                    CssClass="sfInputbox fristName" 
                                ...
                                <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="FirstName"
                                    ...
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvFirstNameResource1"></asp:RequiredFieldValidator>
                            </p>
                        </td>
                        <td>
                            <asp:Label ID="LastNameLabel" runat="server" AssociatedControlID="LastName" 
                                CssClass="sfFormlabel" meta:resourcekey="LastNameLabelResource1" 
                                Text="Last Name:"></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="LastName" runat="server" 
                                    CssClass="sfInputbox lastName" meta:resourcekey="LastNameResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="LastName"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvLastNameResource1"></asp:RequiredFieldValidator>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" 
                                CssClass="sfFormlabel" meta:resourcekey="EmailLabelResource1" 
                                Text="E-mail:"></asp:Label>
                            <span class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBgBig">
                                <asp:TextBox ID="Email" runat="server" CssClass="sfInputbox email" 
                                ...
                                <asp:RequiredFieldValidator ID="rfvEmailRequired" runat="server" ControlToValidate="Email"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvEmailRequiredResource1"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="Email"
                                    SetFocusOnError="True" ErrorMessage="*" 
                                    ValidationGroup="CreateUserWizard1" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                    CssClass="cssClasssNormalRed" meta:resourcekey="revEmailResource1"></asp:RegularExpressionValidator>
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" 
                                CssClass="sfFormlabel" meta:resourcekey="UserNameLabelResource1" 
                                Text="User Name:"></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="UserName" runat="server" 
                                    CssClass="sfInputbox userName" meta:resourcekey="UserNameResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvUserNameRequired" runat="server" ControlToValidate="UserName"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvUserNameRequiredResource1"></asp:RequiredFieldValidator>
                            </p>
                        </td>
                        <td>&nbsp;
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password" 
                                CssClass="sfFormlabel" meta:resourcekey="PasswordLabelResource1" 
                                Text="Password:"></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="Password" runat="server" TextMode="Password" 
                                    CssClass="cssClassNormalTestBox sfInputbox  password" meta:resourcekey="PasswordResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvPasswordRequired" runat="server" ControlToValidate="Password"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvPasswordRequiredResource1"></asp:RequiredFieldValidator>
                        ...
                        <td>
                            <asp:Label ID="ConfirmPasswordLabel" runat="server" AssociatedControlID="ConfirmPassword"
                                ...
                                meta:resourcekey="ConfirmPasswordLabelResource1" Text="Confirm Password:"></asp:Label><span class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="ConfirmPassword" runat="server" TextMode="Password" 
                                    CssClass="sfInputbox confirmPassword" 
                                ...
                                <asp:CompareValidator ID="cvPasswordCompare" runat="server" ControlToCompare="Password"
                                    ...
                                    CssClass="cssClasssNormalRed" 
                                    meta:resourcekey="cvPasswordCompareResource1"></asp:CompareValidator>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="QuestionLabel" runat="server" AssociatedControlID="Question" 
                                CssClass="sfFormlabel" meta:resourcekey="QuestionLabelResource1" 
                                Text="Security Question:"></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="Question" runat="server" 
                                    CssClass="sfInputbox question" meta:resourcekey="QuestionResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvQuestionRequired" runat="server" ControlToValidate="Question"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvQuestionRequiredResource1"></asp:RequiredFieldValidator>
                            </p>
                        </td>
                        <td>
                            <asp:Label ID="AnswerLabel" runat="server" AssociatedControlID="Answer" 
                                CssClass="sfFormlabel" meta:resourcekey="AnswerLabelResource1" 
                                Text="Security Answer:"></asp:Label><span
                                class="cssClassrequired">*</span>
                            <p class="cssClassRegisterInputBg">
                                <asp:TextBox ID="Answer" runat="server" CssClass="sfInputbox answer" 
                                ...
                                <asp:RequiredFieldValidator ID="rfvAnswerRequired" runat="server" ControlToValidate="Answer"
                                    ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                    CssClass="cssClasssNormalRed" meta:resourcekey="rfvAnswerRequiredResource1"></asp:RequiredFieldValidator>
                            </p>
                        </td>
                    </tr>
            ...
            <br />
            <asp:CheckBox ID="chkIsSubscribeNewsLetter" runat="server" 
                CssClass="cssClassCheckBox" 
                meta:resourcekey="chkIsSubscribeNewsLetterResource1" />
             <asp:Label ID="lblIsSubscribeNewsLetter" runat="server" 
                Text="Subscribe Newsletter" CssClass="sfFormlabel" 
                meta:resourcekey="lblIsSubscribeNewsLetterResource1"></asp:Label>
            ...
            <div class="sfButtonwrapper">
             <p>
                    <asp:Button ID="FinishButton" runat="server" AlternateText="Finish" 
                        BorderStyle="None" ValidationGroup="CreateUserWizard1"
                         CssClass="cssClassButtonSubmit" Text="Register" 
                        OnClick="FinishButton_Click" meta:resourcekey="FinishButtonResource1" />
             </p>
                <p>
