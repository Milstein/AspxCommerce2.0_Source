        ...
        <div class="cssClassHeader">
            ...
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">
                    <p>
                        <button type="button" id="btnDeleteSelectedWareHouse" >
                            <span><span class="sfLocale">Delete All Selected</span> </span>
                        </button>
                    </p>
                    <p>
                        <button type="button" id="btnAddWareHouse">
                            <span><span class="sfLocale">Add New Ware House</span></span></button>
                    </p>
                    <div class="clear">
                    </div>
                </div>
        ...
        <div class="cssClassCommonCenterBoxTable">
            <table cellpadding="0" cellspacing="0" border="0">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblStreetAddress" runat="server" Text="Stree Address 1" CssClass="sfFormlabel"
                        ...
                        <td>
                            <asp:Label ID="lblStreetAddress2" runat="server" Text="Stree Address 2" CssClass="sfFormlabel"
                                meta:resourcekey="lblStreetAddress2Resource1"></asp:Label>
                        </td>
                        <td>
                            <input type="text" id="txtStreetAddress2" class="required sfInputbox " name="streetAddress2" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblIsPrimary" runat="server" Text="Is Primary:" CssClass="sfFormlabel"
