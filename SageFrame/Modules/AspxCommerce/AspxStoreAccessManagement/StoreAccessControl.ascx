                                ...
                                <div class="sfButtonwrapper">
                                    ...
                                    <p>
                                        <button type="button" id="btnAddIP">
                                            <span><span class="sfLocale">Add New IP</span></span></button>
                                    </p>
                                ...
                                <div class="sfButtonwrapper">
                                    ...
                                    <p>
                                        <button type="button" id="btnAddDomain">
                                            <span><span class="sfLocale">Add New Domain</span></span></button>
                                    </p>
                                    <div class="cssClassClear">
                                    </div>
                                </div>
                                ...
                                <div class="sfButtonwrapper">
                                    ...
                                    <p>
                                        <button type="button" id="btnAddEmail">
                                            <span><span class="sfLocale">Add New Email</span></span></button>
                                    </p>
                                    <div class="cssClassClear">
                                    </div>
                                </div>
                                ...
                                <div class="sfButtonwrapper">
                                    ...
                                    <p>
                                        <button type="button" id="btnAddCreditCard">
                                            <span><span class="sfLocale">Add New Credit Card</span></span></button>
                                    </p>
                                    <div class="cssClassClear">
                                    </div>
                                </div>
                                ...
                                <div class="sfButtonwrapper">
                                    ...
                                    <p>
                                        <button type="button" id="btnAddCustomer">
                                            <span><span class="sfLocale">Add New Customer</span></span></button>
                                    </p>
                                    <div class="cssClassClear">
                                    </div>
                                </div>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="280">
                                                <label class="cssClassLabel sfLocale">
                                                    AddedOn:</label>
                                                <span class="label class="sfLocale"">From :</span>
