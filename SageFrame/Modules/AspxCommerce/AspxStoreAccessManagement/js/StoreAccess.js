               ...
               $('#btnAddIP,#btnAddDomain,#btnAddEmail,#btnAddCustomer,#btnAddCreditCard').click(function() {
                   ...
                   switch (btn) {
                       case "btnAddIP":
                           ...
                           $('<tr id="IPTO"><td><asp:Label ID="lblIpRangeTo" Text="To:" runat="server" CssClass="cssClassLabel"><span class="cssClassLabel">To:</span></asp:Label> </td><td class="cssClassTableRightCol"><input type="text" id="txtStoreAccessValueTo" class="sfInputbox"  name="ipAddress" /></td></tr>').insertAfter('#forIPonly');
           ...
           EditCoupons: function(tblID, argus) {
               ...
               switch (tblID) {
                   case "gdvIP":
                       ...
                       storeAccessVar = "IP address";
                       $('#txtStoreAccessValue').attr("name", "ipAddress1");
                       $('#' + lblStoreAccessValueID).html(getLoclale(AspxStoreAccessManagement,"Edit IP Range From:"));
                       $('#' + lblAddEditStoreAccessTitleID).html(getLocale(AspxStoreAccessManagement,"Edit IP Range"));
                       $('<tr id="IPTO"><td><asp:Label ID="lblIpRangeTo" Text="To:" runat="server" CssClass="cssClassLabel"><span class="cssClassLabel">To:</span></asp:Label> </td><td class="cssClassTableRightCol"><input type="text" id="txtStoreAccessValueTo" class="sfInputbox"  name="ipAddress" /></td></tr>').insertAfter('#forIPonly');

                       // $('<tr id="IPTO"><td><asp:Label ID="lblIpRange2To" Text="To" runat="server" CssClass="cssClassLabel"><span class="cssClassLabel">To:</span></asp:Label></td><td class="cssClassTableRightCol"><input type="text" id="txtStoreAccessValueTo" class="sfInputbox" /></td></tr>').insertAfter('#forIPonly');
                       Edit = argus[0];
