...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var allowWishListItemListByIds = '<%=AllowWishListItemsById %>';
        ...
        ItemList = {
            ...
            BindShoppingOptionsItemsResult: function(msg) {
                BindTemplateDetails('divOptionsSearchResult', 'divOptionItemViewOptions', 'divOptionViewAs', 'ddlOptionViewAs', 'ddlOptionSortBy', 'divOptionPageNumber', 'OptionPagination', 'ddlOptionPageSize', currentPage, msg, ItemList.BindShoppingOptionResultItems, 'ItemList', allowOutStockPurchase, allowWishListItemListByIds, noImageItemListByIdsPath, noOfItemsInRow, displaymode, templateScriptArr);
            },
            ...
            Init: function() {
                ...
                $("#ddlOptionViewAs").live("change", function() {
                    BindResults('divOptionsSearchResult', 'divOptionViewAs', 'ddlOptionViewAs', null, allowOutStockPurchase, allowWishListItemListByIds, noImageItemListByIdsPath, noOfItemsInRow, displaymode);

                });
                $("#divOptionViewAs").find('a').live('click', function() {
                ...
                $("#ddlOptionSortBy").live("change", function() {
