<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ServicesDetails.ascx.cs" Inherits="Modules_Admin_DetailsBrowse_ServicesDetails" %>
            ...
            BindServiceDetails: function(msg) {
                ...
                if (msg.d.length > 0) {
                    $.each(msg.d, function(index, item) {
                        ...
                        // bindServiceDetails += "<div class='cssImageWrapper'><img src=" + aspxRootPath + item.ItemImagePath.replace('uploads','uploads/Large') + "/></div>";
