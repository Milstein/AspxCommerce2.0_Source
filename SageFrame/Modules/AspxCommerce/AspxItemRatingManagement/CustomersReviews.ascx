...
<div id="divCustomerReviews">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h1>
                <asp:Label ID="lblReviewHeading" runat="server" Text="Customers Reviews" 
                    meta:resourcekey="lblReviewHeadingResource1"></asp:Label>
            </h1>
                ...
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnExportToExcel" CssClass="cssClassButtonSubmit" runat="server"
                            ...
                            OnClientClick="CustomerReviews.ExportDivDataToExcel()" 
                            meta:resourcekey="btnExportToExcelResource1" />
                    </p>
                    <p>
                            <asp:Button  ID="btnExportToCSV" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonCustomerReview_Click" Text="Export to CSV" 
                                OnClientClick="CustomerReviews.ExportCustomerReviewToCsvData()" 
...
<div id="divShowCustomerReviewList" style="display:none">
    <div class="cssClassCommonBox Curve">
        <div class="cssClassHeader">
            <h2>
                <asp:Label ID="lblCRHeading" runat="server" 
                    meta:resourcekey="lblCRHeadingResource1"></asp:Label>
            </h2>
            <div class="cssClassHeaderRight">
                <div class="sfButtonwrapper">                    
                    <p>
                        <asp:Button ID="btnExportReviewsToExcel" CssClass="cssClassButtonSubmit" runat="server"
                            OnClick="Button2_Click" Text="Export to Excel" 
                            OnClientClick="CustomerReviews.ExportDataToExcel()" 
                            meta:resourcekey="btnExportReviewsToExcelResource1" />
                    </p>
                    <p>                    
                            <asp:Button  ID="btnExportReviews" runat="server" class="cssClassButtonSubmit"
                            OnClick="ButtonCustomerReviewDetail_Click" Text="Export to CSV" 
                                OnClientClick="CustomerReviews.ExportCustomerReviewDetailToCsvData()" 
                                meta:resourcekey="btnExportReviewsResource1"/>
                    </p>
                    <p>
