...
$(function() {
    ...
    ItemRatingCriterai = {
        ...
        AddUpdateCriteria: function() {
            ...
            itemCriteriaObj.IsActive = $("#chkIsActive").attr("checked");
        ...
        BindItemRatingCriterialDetails: function(criteria, isAct) {
            ...
            $("#gdvItemRatingCriteria").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxItemRatingManagement, 'Is Active'), name: '_isActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'Yes/No' },
