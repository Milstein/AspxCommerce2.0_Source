    ...
    $(function() {
        ...
        ReturnsSubmit = {
                        ...
                        if (isReturnApplied == 0) {
                            if (orderDateCount != 0) {
                                if (eval(orderDateCount) <= eval(ReturnsSubmit.Vars.ExpiresInDays)) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: aspxservicePath + "AspxCommerceWebService.asmx/ReturnSaveUpdate",
                                        data: param,
                                        contentType: "application/json; charset=utf-8",
                                        dataType: "json",
                                        success: function() {
            ...
            GetAllOrderDetails: function(argus) {
                 orderId = argus;
                this.config.method = "AspxCommerceWebService.asmx/GetMyOrderListForReturn";
            ...
            BindMyOrders: function(msg) {
                ...
                $.each(msg.d, function(index, value) {
                    ...
                    newVariantRow += '<td><textarea id="txtAreaOtherDetails" style="width: 72px; height: 74px;" rows="2" cols="15" class="cssClasstxtAreaOtherDetails"></textarea></td>';
                ...
                if (newVariantRow == '') {
                    ...
                    //$("#divProductInfo").append("<p></br>There is no item to return.</br>Return may be filed already for this Order</p>");
            ...
            GetSettings: function() {
                this.config.url = this.config.baseURL + "AspxCommerceWebService.asmx/ReturnGetSettings";
            ...
            GetProductStatusList: function() {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: this.config.baseURL + "AspxCommerceWebService.asmx/BindProductStatusList",
                    contentType: "application/json; charset=utf-8",
            ...
            BindUserAddress: function() {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: this.config.baseURL + "AspxCommerceWebService.asmx/GetAddressBookDetails",
                    contentType: "application/json; charset=utf-8",
                    data: JSON2.stringify({ aspxCommonObj: aspxCommonObj }),
                    dataType: 'json',
                    success: function(data) {
            ...
            GetReturnReasonList: function() {
                ...
                $.ajax({
                    type: "POST",
                    async: false,
                    url: this.config.baseURL + "AspxCommerceWebService.asmx/BindReturnReasonList",
                    contentType: "application/json; charset=utf-8",
                    data: JSON2.stringify({ aspxCommonObj: aspxCommonObj }),
                    dataType: 'json',
                    success: function(data) {
...
<div id="divReturnSubmit" class="cssClassdivReturnSubmit">
    ...
    <div id="divReturnHeading2" class="cssClassdivReturnHeading2">
...
<div id="divProceed" class="cssClassdivProceed">
    <button type="submit" id="btnGoBack" class="cssClassbtnGoBack">
        <span class="sfLocale">Go Back</span></button>
    <button type="submit" id="btnProceedReturn" class="cssClassbtnProceedReturn">
        <span class="sfLocale">Proceed Return</span></button>
</div>
