                ...
                <div class="sfButtonwrapper">
                    <p>
                        <asp:Button ID="btnExportToExcel" class="cssClassButtonSubmit" runat="server" OnClick="Button1_Click"
                            Text="Export to Excel" OnClientClick="ReturnManage.ExportDivDataToExcel()" meta:resourcekey="btnExportToExcelResource1" />
                    </p>
                    <p>
                        <asp:Button ID="btnExportToCSV" runat="server" class="cssClassButtonSubmit" OnClick="ButtonReturn_Click"
                            Text="Export to CSV" OnClientClick="ReturnManage.ExportReturnsToCsvData()" meta:resourcekey="btnExportToCSVResource1" />
                    </p>
                        ...
                        <tr>
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Return ID:</label>
                                <input type="text" id="txtReturnID" class="sfTextBoxSmall" />
                            </td>
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Order ID:</label>
                            ...
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Return Status:</label>
                                <select id="ddlReturnStatus" class="sfListmenu">
                            ...
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Date Added:</label>
                                <input type="text" id="txtDateAdded" class="sfInputbox" />
                            </td>
                            <td>
                                <label class="cssClassLabel sfLocale">
                                    Date Modified:</label>
                                <input type="text" id="txtDateModified" class="sfTextBoxSmall" />
                            </td>
                            <td>
                                <div class="sfButtonwrapper cssClassPaddingNone">
                                    <p>
                                        <button type="button" onclick="ReturnManage.SearchReturns()">
...
<div class="sfFormwrapper">
    <div class="cssClassCommonBox Curve" id="divReturnDetailForm" style="display: none">
        <div class="cssClassHeader">
            <h2>
        ...
        <div id="divReturnDetailHead">
                ...
                <table id="tblShippingInfo" width="100%">
                    <tr>
                        <td style="text-align: left;">
                            <h4><span class="cssClassLabel sfLocale">Return Shipping Address :</span></h4>
                            <ul id="ulReturnAddress" class="">
                            </ul>
                        </td>
                        <td style="text-align: left;">
                            <h4><span class="cssClassLabel sfLocale">Order Shipping Address :</span></h4>
            ...
            <div id="divItemReturnDetailsForm" class="sfFormwrapper">
                <div id="divReturnInfo" class="sfFormwrapper">
                    <div class="cssClassCommonBox Curve">
                        <div class="cssClassHeader">
                            <h2 class="sfLocale">
                                <span class="sfLocale">Item Return Information:</span></h2>
                        </div>
                        <div class="sfGridwrapper">
                            <div class="sfGridWrapperContent">
                        ...
                        <div id="divComments">
                            ...
                            <div>
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="sfLocale"><b>Notify Customer by Email</b></span>
                                    ...
                                    <button type="button" id="btnSaveComments" class="cssClassButtonSubmit" value="">
...
<div id="divEditReturnStatus" style="display: none">
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfButtonwrapper">
            ...
            <p>
                <button type="button" id="btnUpdateReturnStatus" class="cssClassButtonSubmit" value="">
                    <span><span class="sfLocale">Update</span></span></button>
            </p>
        </div>
        <div class="cssClassClear">
        </div>
