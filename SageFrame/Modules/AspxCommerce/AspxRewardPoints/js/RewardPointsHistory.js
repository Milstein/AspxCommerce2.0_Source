...
$(function() {
    ...
    RewardPointsHistory = {
        ...
        Init: function() {
            ...
            var form2 = $("#form1").validate({
              ignore: ":hidden",
                messages: {
                    ...
                    RewardPoints: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                    },
                    RewardAmount: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                    },
                    RewardPointsExpiresInDays: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                    },
                    MinRedeemBalance: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                    },
                    CappedBalance: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                    },
            ...
            $("#btnSave").bind("click", function() {
                if (form2.form()) {
                    ...
                    // var ed = $("#txtRewardPointsExpiresInDays").val();
            ...
            $("#btnSubmitRewardPointsRuleEdit").bind("click", function() {
                var form3 = $("#form1").validate({
                    ...
                    messages: {
                        ...
                        RewardPointsEdit: { required: '*', number: true,
                            maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                        },
                        PurchaseAmountEdit: { required: '*', number: true,
                            maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                        }
        ...
        GetRewardPointsHistoryByCustomer: function(customerId, dateFrom) {
            ...
            // rewardPointsHistoryObj.DateTo = dateTo;
        ...
        GetRewardPointSettings: function(rewardRuleName, isAct) {
            ...
            $("#gdvRewadPointsSetting").sagegrid({
                ...
                colModel: [
                    ...
                    { display: getLocale(AspxRewardPoints, 'Is Active'), name: 'IsActive', cssclass: 'cssClassHeadBoolean', controlclass: '', coltype: 'label', align: 'left', type: 'boolean', format: 'True/False' },
                    { display: getLocale(AspxRewardPoints, 'Actions'), name: 'action', cssclass: 'cssClassAction', coltype: 'label', align: 'center' }
                ],
        ...
        EditRewardPoints: function(tblID, argus) {
            switch (tblID) {
                case "gdvRewadPointsSetting":
                    ...
                    $("#chkIsActiveEdit").attr('checked', RewardPointsHistory.Boolean(argus[9]));
        ...
        UpdateNewRewardPoints: function() {
            ...
            rewardPointsCommonObj.IsActive = $('#chkIsActiveEdit').attr('checked') ? true : false;
        ...
        GetOrderStatus: function() {
            ...
            this.config.method = "AspxCommerceWebService.asmx/GetStatusList";
        ...
        BindGeneralSettings: function(msg) {
            $.each(msg.d, function(index, item) {
                $("#chkEnableRewardPoints").attr('checked', item.IsActive);
        ...
        SaveGeneralSettings: function() {
            ...
            generalSettingsObj.IsActive = $('#chkEnableRewardPoints').attr('checked') ? true : false;
