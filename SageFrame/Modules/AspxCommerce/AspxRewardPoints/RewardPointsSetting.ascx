        ...
        RewardPointsSetting = {
            ...
            Init: function() {
                ...
                var frm = $("#form2").validate({
                    messages: {
                        RewardRuleNm: { required: '*'
                        },
                        RwrdPoints: { required: '*', number: true,
                        maxlength: getLocale(AspxRewardPoints, "* (no more than 5 digits)")
                        },
                        selectRewardRule: { required: '*'
                        }
                    }
                });
                ...
                $("#btnSaveNewRewardPoints").bind("click", function() {
                    ...
                    if (arr.indexOf(ddlValue) < 0) { // doesn't exist                       
                        if ($('#selectRewardRule option:selected').val() == 0) {
                            $('#selectRewardRule').attr('class', 'sfListmenu error');
                            return false;
                        }
                        else if (frm.form()) {
            ...
            SaveNewRewardPoints: function() {
                ...
                rewardPointsCommonObj.IsActive = $('#chkIsActiveRule').attr('checked') ? true : false;
    ...
    <div class="cssClassCommonBox Curve">
        ...
        <div class="sfGridwrapper sfFormwrapper">
            <div class="sfGridWrapperContent">
                <table id="tblNewEwardPoint" width="50%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                    ...
                    <tr id="trAmount" style="display: none;">
                        ...
                        <td>
                            <input type="text" id="txtPurchaseAmount" class="sfInputbox" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <div class="sfButtonwrapper ">
                                <button id="btnSaveNewRewardPoints" type="button">
                                    <span><span class="sfLocale">Save Reward Rule</span></span></button>
