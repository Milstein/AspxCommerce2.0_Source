...
public class SiteMapWebService : System.Web.Services.WebService {
    ...
    [WebMethod]
    public List<MenuManagerInfo> GetSitemap(int PortalID, string UserName, string CultureCode, int UserModuleID)
    {
