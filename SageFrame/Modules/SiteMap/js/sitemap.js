$(function() {
    var SiteMap = {
        ...
        GetPagesForSiteMap: function() {
            ...
            SiteMap.config.data = JSON2.stringify({ PortalID: SiteMap.config.PortalID, UserName: SiteMap.config.UserName, CultureCode: SiteMap.config.CultureName, UserModuleID: SiteMap.config.UserModuleID });
