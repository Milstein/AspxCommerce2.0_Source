            ...
            BindEvents: function() {
                ...
                $('#btnAddQuickLink').bind("click", function() {
                    if (v.form()) {
                        ...
                        order = order + 1;
                        var url = $('#ddlPages option:selected').val() + SageFrameSettingKeys.PageExtension;
                ...
                $('#btnAddSidebar').bind("click", function() {
                    ...
                    if (v.form()) {
                        ...
                        order = order + 2;
                        var url = $('#ddlPagesSidebar option:selected').val() + SageFrameSettingKeys.PageExtension;
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        $.each(pages, function(index, item) {
                            html += '<option value=' + item.PageID + '>' + item.PageName + SageFrameSettingKeys.PageExtension + '</option>';
                        });
                        $(id).html(html);
                        $('#ajaxBusy').hide();
                    }
            ...
            LoadSidebarItem: function(sidebaritemid) {
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        $('#ddlPagesSidebar').val(sidebar.URL.replace(SageFrameSettingKeys.PageExtension, ""));
            ...
            LoadQuickLinkItem: function(quicklinkitemid) {
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        $('#ddlPages').val(quicklink.URL.replace(SageFrameSettingKeys.PageExtension, ""));
                    }
                });
            },
