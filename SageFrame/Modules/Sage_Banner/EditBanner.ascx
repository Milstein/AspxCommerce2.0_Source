...
<asp:Panel ID="pnlBannercontainer" Style="display: none;" runat="server" CssClass="sfFormwrapper"
            ...
            <ContentTemplate>
                ...
                <div id="divbannerImageContainer" runat="server">
                    <div class="sfButtonwrapper sftype1">
                        <label id="imbAddNewImage" class="sfAdd">
        ...
        <cc1:TabPanel ID="tpSageBannerHTML" runat="server">
            ...
            <ContentTemplate>
                ...
                <div id="divHtmlBannerContainer" runat="server">
                    <div class="sfButtonwrapper sftype1">
                        <asp:ImageButton ID="imAddHtmlContent" runat="server" ValidationGroup="save" OnClick="imAddHtmlContent_Click" />
                        <asp:Label runat="server" ID="imbAddHtmlContent" AssociatedControlID="imAddHtmlContent">Add HtmlContent</asp:Label>
                        <%-- <label id="imbAddHtmlContent" class="sfAdd">
                            Add HTML Content</label>--%>
                    </div>
    ...
    <div class="sftype1 sfMargintop">
        <asp:ImageButton runat="server" ID="imbReturnBack" CssClass="sfCancel" OnClick="imbReturnBack_Click" />
        <asp:Label runat="server" ID="lblReturnBack" Text="Back" AssociatedControlID="imbReturnBack" />
    </div>
</asp:Panel>
<asp:Panel ID="pnlBannerList" runat="server" meta:resourcekey="pnlPageListResource1"
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td>
                <div class="sfButtonwrapper">
                    <asp:ImageButton ID="imbSaveBanner" runat="server" CssClass="sfAdd" ValidationGroup="bannername"
                        OnClick="imbSaveBanner_Click" />
    ...
    <div class="sfGridwrapper">
        <asp:GridView ID="gdvBannerList" AllowPaging="true" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgEdit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("BannerID")%>'
                            CommandName="BannerEdit" ImageUrl='<%# GetTemplateImageUrl("imgedit.png", true) %>' />
                    </ItemTemplate>
                    <HeaderStyle CssClass="sfDelete" VerticalAlign="Top" />
                    <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
