    ...
    $.createSearchResult = function(p) {
        ...
        var SearchResult = {
            ...
            GetSearchResult: function(offset, limit, current) {
                ...
                SearchResult.config.data = JSON2.stringify({ offset: offset, limit: limit, Searchword: searchWord, SearchBy: p.UserName, CultureName: p.CulturalName, IsUseFriendlyUrls: p.IsUseFriendlyUrls, PortalID: p.PortalID });
            ...
            BindSearchResult: function(data) {
                ...
                if (data.d.length > 0) {
                    ...
                    $.each(data.d, function(index, value) {
                        ...
                        html += '<li id="liSearchResult" class="sfSearchList"><a href="' + value.URL + '"><h1>' + value.PageName + '</h1></a>';
