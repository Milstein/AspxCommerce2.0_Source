    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvScreenName" runat="server" ErrorMessage="*" ControlToValidate="txtScreenName"
                    ValidationGroup="twitterdecksetting" CssClass="cssClassNormalRed"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:RangeValidator ControlToValidate="txtTwittsCount" MinimumValue="0" ValidationGroup="twitterdecksetting"
                    MaximumValue="500" ID="RangeValidator1" runat="server" ErrorMessage="Invalid Count"></asp:RangeValidator>
                <asp:RequiredFieldValidator ID="rfvTwittsCount" runat="server" ErrorMessage="*" ControlToValidate="txtTwittsCount"
                    ValidationGroup="twitterdecksetting" CssClass="cssClassNormalRed"></asp:RequiredFieldValidator>
