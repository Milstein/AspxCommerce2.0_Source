...
<div class="sfFormwrapper">
    <div class="sfGridwrapper">
        <asp:GridView runat="server" ID="gdvContacters" Width="100%" AutoGenerateColumns="false"
            ...
            OnRowUpdating="gdvContacters_RowUpdating" EmptyDataText="...No Contact Found...">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:ImageButton ID="imbDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("ContactUsID") %>'
