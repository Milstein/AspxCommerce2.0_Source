$(function() {
    ...
    var NewsLetterEdit = {
        ...
        LoadMessageTemplateType: function() {
            ...
            NewsLetterEdit.config.data = JSON2.stringify({ PortalID: NewsLetterEdit.config.PortalID, UserName: NewsLetterEdit.config.UserName, CultureName: NewsLetterEdit.config.CultureName });
        ...
        GetSetting: function() {
            var param = JSON2.stringify({ UserModuleID: NewsLetterEdit.config.UserModuleID, PortalID: NewsLetterEdit.config.PortalID });
            $.ajax({
                type: "POST",
        ...
        GetMessageTemplateList: function(current, pageSize) {
            var mydata = JSON2.stringify({ current: current, pageSize: pageSize, PortalID: NewsLetterEdit.config.PortalID, UserName: NewsLetterEdit.config.UserName, CultureName: NewsLetterEdit.config.CultureName });
            $.ajax({
                type: "POST",
                async: false,
    ...
    NewsLetterEdit.init();
    $("#ddlMessageTemlate").live("change", function() {
        var TemplateTypeID = $(this).val();
        NewsLetterEdit.GetMessageTemplateByTypeID(TemplateTypeID);
    });
    $("#btnAddSubjectToken").die().live("click", function() {
    ...
    $("#btnAddToken").die().live("click", function() {
    ...
    $("#btnAddBodyMsgToken").die().live("click", function() {
    ...
    $("#btnSubsciberAdd").die().live("click", function() {
    ...
    $("#btnSendEmail").die().live("click", function() {
        // e.preventDefault();
    ...
    $("#btnEmailOK").die().live("click", function() {
