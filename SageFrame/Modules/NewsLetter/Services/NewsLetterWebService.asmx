...
public class NewsLetterWebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public void SaveEmailSubscriber(string Email, int UserModuleID, int PortalID, string UserName)
    {
        try
        {
    ...
    [WebMethod]
    public void SaveMobileSubscriber(Int64 Phone, int UserModuleID, int PortalID, string UserName)
    {
        try
        {
            string clientIP = HttpContext.Current.Request.UserHostAddress.ToString();
    ...
    [WebMethod]
    public List<MessageManagementInfo> LoadMessageTemplateType(int PortalID, string UserName, string CultureName)
    {
        try
        {
    ...
    [WebMethod]
    public List<MessageManagementInfo> GetMessageTokenByTemplate(int MessageTemplateTypeID, int PortalID)
    {
        try
        {
            MessageManagementController msgController = new MessageManagementController();
    ...
    [WebMethod]
    public List<MessageManagementInfo> GetMessageTemplateList(int current, int pageSize, int PortalID, string UserName, string CultureName)
    {
        try
        {
            NL_Controller cont = new NL_Controller();
