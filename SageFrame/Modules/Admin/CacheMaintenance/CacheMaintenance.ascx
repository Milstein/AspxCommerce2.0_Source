...
<div class="sfFormwrapper" style="width: 100%;">
    <div id="divClearCache" style="width: 49%; float: left;">
        <fieldset>
            ...
            <div class="sfButtonwrapper sftype1">
                <label id="btnSave" class="sfClear">
                    Clear Cache</label>
            </div>
        </fieldset>
    </div>
    <div id="divHeavyCache" style="width: 49%; float: right;" class="sfGridwrapper">
        <fieldset>
            ...
            <div class="sfButtonwrapper sftype1">
                <label id="btnEnableCache" class="sfCache">
