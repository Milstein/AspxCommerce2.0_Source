...
<script type="text/javascript">
    //<![CDATA[
    $(function() {
        $('#divModulesLists input:checkbox:first').live("change", function() {
            if ($(this).is(":checked")) {
                $('#divModulesLists input:checkbox:not(:disabled)').attr("checked", true);
            }
            else {
                $('#divModulesLists input:checkbox:not(:disabled)').attr("checked", false);
            }
        });
    });
    //]]>
...
<asp:PlaceHolder ID="ExtensionPlaceHolder" runat="server">
    <div class="sfFormwrapper sfPadding">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                ...
                <td width="200">
                    <asp:TextBox ID="txtSearchText" runat="server" CssClass="sfInputbox text" meta:resourcekey="txtSearchTextResource1"></asp:TextBox>
                </td>
                <td>
                    <div class="sfButtonwrapper">
                        ...
                        <asp:Label ID="lblSearch" runat="server" Text="Search" AssociatedControlID="imgSearch"
                            CssClass="sfFormlabel" meta:resourcekey="lblSearchResource1"></asp:Label>
                    </div>
                </td>
                <td>
                </td>
    ...
    <div class="sfButtonwrapper sfPadding">
        ...
        <asp:Label Style="cursor: pointer;" ID="lblInstallModule" runat="server" Text="Install Module"
            AssociatedControlID="imbInstallModule" meta:resourcekey="lblInstallModuleResource1" />
        ...
        <asp:Label Style="display: none" ID="lblAvailableModule" runat="server" Text="Available Module"
            AssociatedControlID="imbAvailableModules" meta:resourcekey="lblAvailableModuleResource1" />
        ...
        <asp:Label Style="cursor: pointer;" ID="lblCreateCompositeModule" runat="server"
            Text="Create Composite Module" AssociatedControlID="imbCreateCompositeModule"
        ...
        <asp:Label Style="cursor: pointer;" ID="lblCreatePackage" runat="server" Text="Create Package"
            AssociatedControlID="imbCreatePackage" meta:resourcekey="lblCreatePackageResource1" />
    </div>
