          ...
          <div id="divModuleSettings" runat="server" class="sfCollapsecontent">
            ...
            <h2>Module Settings</h2>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td width="20%"><asp:Label ID="lblCreate" runat="server" Text="Create Module From" 
                                            CssClass="sfFormlabel"></asp:Label></td>
                  <td><asp:DropDownList ID="ddlCreate" runat="server" CssClass="sfListmenu" 
                                             meta:resourcekey="ddlCreateResource1">
                      <asp:ListItem Value="Control" Text="Control" 
                                                meta:resourcekey="ListItemResource1" />
                    </asp:DropDownList></td>
                </tr>
                <tr>
                  <td><asp:Label ID="lblOwnerFolder" runat="server" Text="Owner Folder" 
                                            CssClass="sfFormlabel"></asp:Label></td>
                  <td><asp:DropDownList ID="ddlOwner" runat="server" CssClass="sfListmenu"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlOwner_SelectedIndexChanged" 
                                            meta:resourcekey="ddlOwnerResource1" /></td>
                </tr>
                <tr>
                  <td><asp:Label ID="lblModuleFolder" runat="server" Text="Module Folder" 
                                            CssClass="sfFormlabel"></asp:Label></td>
                  <td><asp:DropDownList ID="ddlModule" runat="server" CssClass="sfListmenu"
                                            AutoPostBack="True" 
                ...
                <tr>
                  <td><asp:Label ID="lblFiles" runat="server" Text="Source" 
                                            CssClass="sfFormlabel"></asp:Label></td>
                  <td><asp:DropDownList ID="ddlFiles" runat="server"
                                            CssClass="sfListmenu" meta:resourcekey="ddlFilesResource1" /></td>
                </tr>
              </table>
            </div>
          </div>
