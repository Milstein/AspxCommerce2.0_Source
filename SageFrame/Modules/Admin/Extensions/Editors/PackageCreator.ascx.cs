...
namespace SageFrame.Modules.Admin.Extensions.Editors
{
    ...
    {       
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "GlobalVariable1", " var CancelURL='" + ResolveUrl("~/") + "Super-User/Modules" + SageFrameSettingKeys.PageExtension + "';", true);
