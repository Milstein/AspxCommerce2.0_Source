...
<asp:Panel ID="pnlManageUser" runat="server" CssClass="sfFormwrapper sfPadding" meta:resourcekey="pnlManageUserResource1">
            ...
            <ContentTemplate>
                ...
                <div class="sfButtonwrapper">
                    <asp:ImageButton ID="imgUserInfoSave" runat="server" OnClick="imgUserInfoSave_Click"
                        ToolTip="Update" ValidationGroup="vgManageUserInfo" meta:resourcekey="imgUserInfoSaveResource1" />
                    <asp:Label ID="lblUserInfoSave" runat="server" Text="Update" AssociatedControlID="imgUserInfoSave"
                        Style="cursor: pointer;" ValidationGroup="vgManageUserInfo" meta:resourcekey="lblUserInfoSaveResource1"></asp:Label>
                </div>
            </ContentTemplate>
        </ajax:TabPanel>
                    ...
                    <div class="sfViewprofile">
                        <table id="tblEditProfile" width="100%" cellpadding="0" cellspacing="0" runat="server">
                            ...
                            <tr runat="server">
                                <td runat="server">
                                    <div class="sfButtonwrapper">
                                        <asp:Button ID="btnSave" runat="server" CssClass="sfBtn" OnClick="btnSave_Click"
                                            Text="Save" ValidationGroup="rfvUserProfile" />
                                        <asp:Button ID="btnCancelProfile" runat="server" CssClass="sfBtn" OnClick="btnCancelProfile_Click"
                                            Text="Cancel" />
                                    </div>
                                </td>
                            </tr>
                        ...
                        <div class="sfViewprofile">
                            <table id="tblViewProfile" cellpadding="0" cellspacing="0" width="100%" runat="server">
                                ...
                                <tr id="trviewBirthDate" runat="server">
                                    <td runat="server">
                                        <asp:Label ID="lblBirthDateTest" runat="server" Text="BirthDate" CssClass="sfFormlabel"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr runat="server">
                                    <td runat="server">
                                        <div class="sfButtonwrapper">
                                            <asp:Button ID="btnEdit" runat="server" CssClass="sfBtn" OnClick="btnEdit_Click"
                                                Text="Edit" />
                                        </div>
                                    </td>
                                </tr>
...
<asp:Panel ID="pnlUser" runat="server" meta:resourcekey="pnlUserResource1">
    ...
    <div class="sfButtonwrapper">
        <asp:ImageButton ID="imbCreateUser" ValidationGroup="CreateUser" runat="server" ToolTip="Add Users"
            OnClick="imbCreateUser_Click" meta:resourcekey="imbCreateUserResource1" />
        ...
        <asp:ImageButton ID="imbBackinfo" runat="server" OnClick="imgBack_Click" ToolTip="Back"
            meta:resourcekey="imbBackinfoResource1" />
        <asp:Label ID="lblBackinfo" runat="server" Text="Back" AssociatedControlID="imbBackinfo"
            meta:resourcekey="lblBackinfoResource1"></asp:Label>
    </div>
</asp:Panel>
<asp:Panel ID="pnlUserList" runat="server" meta:resourcekey="pnlUserListResource1">
    <div class="sfButtonwrapper sfPadding">
        <asp:ImageButton ID="imgAddUser" runat="server" OnClick="imgAddUser_Click" ToolTip="Add User"
            meta:resourcekey="imgAddUserResource1" />
        ...
        <asp:ImageButton ID="imgBtnDeleteSelected" runat="server" OnClientClick="return ValidateCheckBoxSelection(this)"
            OnClick="imgBtnDeleteSelected_Click" ToolTip="Delete all seleted" meta:resourcekey="imgBtnDeleteSelectedResource1" />
        ...
        <asp:ImageButton ID="imgBtnSaveChanges" runat="server" OnClick="imgBtnSaveChanges_Click"
            ToolTip="Update changes" OnClientClick="return ConfirmDialog(this, 'Confirmation', 'Are you sure you want to save the changes?');"
        ...
        <asp:ImageButton ID="imgBtnSettings" runat="server" ToolTip="UserSettings" OnClick="imgBtnSettings_Click"
            meta:resourcekey="imgBtnSettingsResource1" />
                ...
                <td>
                    <div class="sfButtonwrapper">
                        ...
                        <asp:Label ID="lblSearch" runat="server" Text="Search" AssociatedControlID="imgSearch"
                            Style="cursor: pointer;" CssClass="sfFormlabel" meta:resourcekey="lblSearchResource1"></asp:Label>
                    </div>
                </td>
            </tr>
        </table>
                ...
                <asp:TemplateField meta:resourcekey="TemplateFieldResource9">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgDelete" runat="server" CausesValidation="False" CommandArgument='<%# Container.DataItemIndex %>'
                            ...
                            ImageUrl='<%# GetTemplateImageUrl("imgdelete.png", true) %>' ToolTip="Delete User"
...
<asp:Panel ID="pnlSettings" runat="server" meta:resourcekey="pnlSettingsResource1">
    <div class="sfFormwrapper sfPadding">
        ...
        <div class="sfButtonwrapper">
            ...
            <asp:Label ID="Label1" runat="server" Text="Save" AssociatedControlID="btnSaveSetting"
                meta:resourcekey="Label1Resource1"></asp:Label>
            <asp:ImageButton ID="btnCancel" runat="server" OnClick="btnCancel_Click" ToolTip="Cancel"
                meta:resourcekey="btnCancelResource1" />
            <asp:Label ID="Label3" runat="server" Text="Cancel" AssociatedControlID="btnCancel"
