...
<script type="text/javascript">
    //<![CDATA[ 
    $(function() {
    $(this).MenuManager({ PortalID: '<%=PortalID %>', UserModuleID: '<%=UserModuleID %>', CultureCode: '<%=CultureCode %>' });
    });
    //]]>	
</script>
...
<div class="sfFormwrapper sfPadding">
    <fieldset>
        ...
        <div class="sfButtonwrapper sftype1 sfDefaultSave">
            <label id="btnSaveMenu" class="sfSave">
                Save</label>
        </div>
    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="sfQuicklink">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="2">
                                        <label id="lblAddMenu" class="sfFormlabel">
                                            Add Menu</label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="sfButtonwrapper sftype1" id="divAdd">
                                            <label id="imgAdd" class="sfAdd" style="display: none">
                                                Create</label>
                                            <label id="imgUpdate" class="sfUpdate">
                                                Update</label>
                                            <label id="imgCancel" class="sfMenuCancel">
                                                Cancel</label>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div class="sfButtonwrapper sftype1">
                                                <label id="imgAddmenuItem" class="sfAdd">
                                                    Add Menu Item</label>
                                                <label id="imgAddMenuCancel" class="sfCancel">
                                                    Cancel</label>
                                            </div>
                                        </td>
                                    </tr>
