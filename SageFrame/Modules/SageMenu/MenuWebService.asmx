...
public class MenuWebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public void AddNewMenu(List<MenuPermissionInfo> lstMenuPermissions, string MenuName, string MenuType, bool IsDefault, int PortalID, string CultureCode)
    {
    ...
    [WebMethod]
    public void UpdateMenu(List<MenuPermissionInfo> lstMenuPermissions, int MenuID, string MenuName, string MenuType, bool IsDefault, int PortalID, string CultureCode)
    {
    ...
    [WebMethod]
    public void DeleteMenu(int MenuID, string CultureCode, int PortalID)
    {
