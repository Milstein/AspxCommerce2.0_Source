...
<%@ Register Src="~/Modules/Language/LocalModuleTitle.ascx" TagName="ModuleTitleEditor" TagPrefix="uc6" %>
...
<div id="fade">
</div>        <asp:HiddenField ID="hdntemp"  Value="" runat="server"/>
<asp:HyperLink ID="hlRefresh" runat="server" NavigateUrl="~/SageFrame/Admin/Localization.aspx"  Visible="false">There has been few action on the website's culture so ,Please click here to refresh the page.</asp:HyperLink>
    ...
    <div class="sfButtonwrapper">
        ...
        <asp:Label ID="Label1" runat="server" Text="Localize Menu" AssociatedControlID="imbLocalizeMenu"
            Style="cursor: pointer;" meta:resourcekey="Label1Resource1"></asp:Label>
             <asp:ImageButton ID="imbLocalizeModuleTitle" OnClick="imbLocalizeModuleTitle_Click" runat="server"
          Style="width: 14px;" />
        <asp:Label ID="lblLocalizemoduletitle" runat="server" Text="Localize Module Title" AssociatedControlID="imbLocalizeModuleTitle"
                                ...
                                <asp:TemplateField meta:resourcekey="TemplateFieldResource7">
                                    <ItemTemplate>
                                        <asp:Image ID="imgEditResxValue" CssClass="sfEdit" AlternateText="<%# Container.DataItemIndex+1 %>"
                                            runat="server" ImageUrl="~/Administrator/Templates/Default/images/imgedit.png"
