...
namespace AspxCommerce.Core
{
    public class AspxCouponManageProvider
    {
        ...
        public static List<LatestItemsInfo> GetAllPromoCodesForView(int couponId,AspxCommonInfo aspxCommomObj)
        {
            try
            {
                List<KeyValuePair<string, object>> parameter = CommonParmBuilder.GetParamSPUC(aspxCommomObj);
                parameter.Add(new KeyValuePair<string, object>("@CouponID",couponId));
                SQLHandler sqlh = new SQLHandler();
                List<LatestItemsInfo> lst = sqlh.ExecuteAsList<LatestItemsInfo>("dbo.usp_Aspx_GetAllPromoCodeItemsForView", parameter);
                return lst;
            }
            catch (Exception ex)
            {
        ...
        public static List<CouponInfo> GetPromoCodesForView(AspxCommonInfo aspxCommomObj)
        {
            try
            {
                List<KeyValuePair<string, object>> parameter = CommonParmBuilder.GetParamSPC(aspxCommomObj);
                SQLHandler sqlh = new SQLHandler();
                List<CouponInfo> lst = sqlh.ExecuteAsList<CouponInfo>("[dbo].[usp_Aspx_PromoCodeList]", parameter);
                return lst;
            }
            catch (Exception ex)
            {
        ...
        public static List<CouponStatusInfo> BindCouponStatus()
        {
            SQLHandler sqlH = new SQLHandler();
            List<CouponStatusInfo> lstCoupStat = sqlH.ExecuteAsList<CouponStatusInfo>("usp_Aspx_GetCouponStatus");
            return lstCoupStat;
        }
        ...
        public static void UpdateCouponUserRecord(string couponCode, int storeID, int portalID, string userName, int orderID)
        {
