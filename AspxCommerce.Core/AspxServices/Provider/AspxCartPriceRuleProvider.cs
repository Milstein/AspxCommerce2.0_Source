   ...
   public class AspxCartPriceRuleProvider
    {
       ...
       public static int RuleConditionAdd(List<RuleCondition> lstRuleCondition, int cartPriceRuleID, object parentID, SqlTransaction tran, AspxCommonInfo aspxCommonObj)
       {
           try
           {
