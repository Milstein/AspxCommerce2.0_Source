   ...
   public class AspxServiceProvider
    {
       ...
       public static List<ServiceInfo> GetAllServices(AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               List<ServiceInfo> lstService= sqlH.ExecuteAsList<ServiceInfo>("[usp_Aspx_GetAllServices]", parameterCollection);
               return lstService;
           }
           catch (Exception e)
           {
       ...
       public static List<FrontServiceView> GetFrontServices(AspxCommonInfo aspxCommonObj, int count)
       {
           try
           {
               ...
               SQLHandler sqlH = new SQLHandler();
               List<FrontServiceView> lstService = sqlH.ExecuteAsList<FrontServiceView>("[usp_Aspx_GetFrontServices]", parameterCollection);
               return lstService;
           }
           catch (Exception e)
           {
       ...
       public static List<ServiceItemDetailsInfo> GetServiceItemDetails(int itemID, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               SQLHandler sqlH = new SQLHandler();
               List<ServiceItemDetailsInfo> lstSIDetail= sqlH.ExecuteAsList<ServiceItemDetailsInfo>("[usp_Aspx_GetServiceItemDetails]", parameterCollection);
               return lstSIDetail;
           }
           catch (Exception e)
           {
       ...
       public static bool SaveBookAppointment(int appointmentId, AspxCommonInfo aspxCommonObj, BookAppointmentInfo obj)//upto this 1/13/2013
       {
           var isSuccess = false;
           try
           {
       ...
       public static List<ServiceProductInfo> GetServiceProducts(int serviceId, AspxCommonInfo aspxCommonObj)
       {
           try
           {
               ...
               SQLHandler sqlh = new SQLHandler();
               List<ServiceProductInfo> lstServProduct= sqlh.ExecuteAsList<ServiceProductInfo>("[dbo].[usp_Aspx_GetServiceProducts]", parameter);
       ...
       public static void SendMailNotificatiion(int storeId, int portalId, string cultureName, BookAppointmentInfo objInfo)
       {
