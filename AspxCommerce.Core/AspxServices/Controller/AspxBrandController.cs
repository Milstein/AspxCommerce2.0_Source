   ...
   public class AspxBrandController
    {
       ...
       public static List<BrandInfo> GetAllBrandForSlider(AspxCommonInfo aspxCommonObj)
       {
           try
           {
               List<BrandInfo> objAllBrand = AspxBrandProvider.GetAllBrandForSlider(aspxCommonObj);
               return objAllBrand;
           }
           catch (Exception e)
           {
       ...
       public static List<BrandInfo> GetAllFeaturedBrand(AspxCommonInfo aspxCommonObj,int Count)
       {
           try
           {
               List<BrandInfo> lstBrand = AspxBrandProvider.GetAllFeaturedBrand(aspxCommonObj,Count);
               return lstBrand;
           }
           catch (Exception e)
           {
