...
namespace AspxCommerce.Core
{
    public class AspxCouponManageController
    {
        ...
        public static List<LatestItemsInfo> GetAllPromoCodesForView(int couponId,AspxCommonInfo aspxCommonObj)
        {
            try
            {
                List<LatestItemsInfo> list = AspxCouponManageProvider.GetAllPromoCodesForView(couponId,aspxCommonObj);
                return list;
            }
            catch (Exception ex)
            {
        ...
        public static List<CouponInfo> GetPromoCodesForView(AspxCommonInfo aspxCommonObj)
        {
            try
            {
                List<CouponInfo> list = AspxCouponManageProvider.GetPromoCodesForView(aspxCommonObj);
                return list;
            }
            catch (Exception ex)
            {
        ...
        {
            List<CouponStatusInfo> lstCoupStat = AspxCouponManageProvider.BindCouponStatus();
            return lstCoupStat;
        }
