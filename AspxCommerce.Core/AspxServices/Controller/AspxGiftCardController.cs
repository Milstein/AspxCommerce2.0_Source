...
namespace AspxCommerce.Core
{
    public class AspxGiftCardController
    {
        ...
        public static void IssueGiftCard(string giftCardIds, AspxCommonInfo aspxCommonObj)
        {
            try
            {
                AspxGiftCardProvider.IssueGiftCard(giftCardIds, aspxCommonObj);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public static void IssueGiftCard(List<OrderItemInfo> itemList, bool isActive, AspxCommonInfo aspxCommonObj)
        {
            try
            {
                AspxGiftCardProvider.IssueGiftCard(itemList, isActive, aspxCommonObj);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public static void IssueGiftCardForMobile(List<OrderItem> itemList, bool isActive, AspxCommonInfo aspxCommonObj)
        {
            try
            {
                AspxGiftCardProvider.IssueGiftCardForMobile(itemList, isActive, aspxCommonObj);
            }
            catch (Exception e)
            {
                throw e;
