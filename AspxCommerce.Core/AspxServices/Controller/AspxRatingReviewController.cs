  ...
  public class AspxRatingReviewController
    {
      ...
      public static List<ItemsReviewInfo> GetAllItemList(AspxCommonInfo aspxCommonObj)
      {
          try
          {
              List<ItemsReviewInfo> items = AspxRatingReviewProvider.GetAllItemList(aspxCommonObj);
              return items;
          }
          catch (Exception e)
          {
