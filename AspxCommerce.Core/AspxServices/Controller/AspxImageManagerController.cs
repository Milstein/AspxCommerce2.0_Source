    ...
    public class AspxImageManagerController
    {
                                             ...
                                             AspxCommonInfo aspxCommonObj)
        {
            try
            {
                ...
                StoreSettingConfig ssc = new StoreSettingConfig();
                int largeSize = int.Parse(ssc.GetStoreSettingsByKey(StoreSetting.ItemLargeThumbnailImageSize, aspxCommonObj.StoreID,
                                                                   aspxCommonObj.PortalID,
                                                                   aspxCommonObj.CultureName));
                int midSize = int.Parse(ssc.GetStoreSettingsByKey(StoreSetting.ItemMediumThumbnailImageSize, aspxCommonObj.StoreID,
                                                                  aspxCommonObj.PortalID,
                                                                  aspxCommonObj.CultureName));
                int smallSize = int.Parse(ssc.GetStoreSettingsByKey(StoreSetting.ItemSmallThumbnailImageSize, aspxCommonObj.StoreID,
                                                                  aspxCommonObj.PortalID,
                                                                  aspxCommonObj.CultureName));
                ...
                PictureManager.CreateThmnail(HttpContext.Current.Server.MapPath(source), largeSize,
                                             HttpContext.Current.Server.MapPath(largePath));
                PictureManager.CreateThmnail(HttpContext.Current.Server.MapPath(source), midSize, HttpContext.Current.Server.MapPath(midPath));
                PictureManager.CreateThmnail(HttpContext.Current.Server.MapPath(source), smallSize, HttpContext.Current.Server.MapPath(smallPath));
            }
            catch (Exception)
            {
