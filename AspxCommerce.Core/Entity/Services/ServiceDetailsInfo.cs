...
namespace AspxCommerce.Core
{
    ...
    public class ServiceDetailsInfo
    {
        ...
        [DataMember] private int _categoryID;
        [DataMember] private int _itemID;
        [DataMember] private string _itemName;
        [DataMember] private decimal _price;
        [DataMember] private string _shortdescription;
        [DataMember] private string _itemImagePath;
        [DataMember] private string _categoryImagePath;
        [DataMember] private string _categoryDetails;
        [DataMember] private int _serviceDuration;
        [DataMember] private string _categoryName;
