...
namespace AspxCommerce.Core
{
   [DataContract]
    [Serializable]
    public class CategoryWiseItemInfo
    {
         #region Constructor
       public CategoryWiseItemInfo()
        {
        }
        #endregion
       ...
       [DataMember] private int _itemRowNum;
        #endregion
       ...
       public int RowTotal
       {
        ...
        public int ItemRowNum
        {
            get
            {
                return this._itemRowNum;
            }
            set
            {
                if ((this._itemRowNum != value))
                {
                    this._itemRowNum = value;
                }
            }
        }
        #endregion
