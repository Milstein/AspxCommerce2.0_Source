...
namespace AspxCommerce.CashOnDelivery
{
    public class CashOnDelivery
    {
        ...
        public static void UpdateItemQuantityAndCoupon(OrderInfo orderInfo, List<OrderItem> itemsInfo, string coupon, int storeId, int portalId, string userName)
        {
            try
            {
                string error = "";
                            ...
                            var paraMeter = new List<KeyValuePair<string, object>>
                                                {
                                                    ...
                                                    new KeyValuePair<string, object>("@CouponUsedCount",
                                                                                     coupondetails[1]),
